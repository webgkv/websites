...
if ($logo_alt === '' || strpos($logo_alt, 'common|') === 0) {
	$logo_alt = function_exists('site_brand_name') ? site_brand_name() : 'Aviator';
}
...
$icon_path = (defined('ROOT_DIR') && file_exists(ROOT_DIR . 'assets/images/aviator-icon.svg'))
	? ROOT_DIR . 'assets/images/aviator-icon.svg'
	: '';
...
<div class="demo-app-shell">
	<header class="demo-app-bar" role="banner">
		...
		<a class="demo-app-brand" href="<?= htmlspecialchars($demo_back_url, ENT_QUOTES, 'UTF-8') ?>"
			...
			<img class="demo-app-logo-icon" src="/assets/images/aviator-icon.svg?v=<?= (int) $logo_v ?>" alt="" width="40" height="24" decoding="async">
		</a>
