...
$en = array(
	...
	'quick_lead' => 'Open the fullscreen demo in Safari — <a href="https://aviator-log-in.com/en/demo/app/">https://aviator-log-in.com/en/demo/app/</a>. Then follow the steps below, starting with the ⋯ menu.',
	'step1_title' => 'Step 1 — ⋯ menu',
	'step1_body' => 'Tap the <strong>⋯</strong> button (three dots) in Safari\'s toolbar.',
	'step1_img_alt' => '⋯ menu button in Safari on the Aviator demo page',
	'step2_title' => 'Step 2 — Share',
	'step2_body' => 'Choose <strong>Share</strong> — in Safari this is usually the square with an up arrow.',
	'step2_img_alt' => 'Share button in Safari on the Aviator demo page',
...
return array(
	...
	'fr' => array(
		...
		'quick_lead' => 'Ouvrez la démo plein écran dans Safari — <a href="https://aviator-log-in.com/fr/demo/app/">https://aviator-log-in.com/fr/demo/app/</a>. Puis suivez les étapes ci-dessous, en commençant par le bouton ⋯.',
		'step1_title' => 'Étape 1 — bouton ⋯',
		'step1_body' => 'Touchez le bouton <strong>⋯</strong> (trois points) dans la barre d’outils Safari.',
		'step1_img_alt' => 'Bouton ⋯ dans Safari sur la page démo Aviator',
	...
	'de' => array(
		...
		'quick_lead' => 'Öffnen Sie die Vollbild-Demo in Safari, z. B. <a href="https://aviator-log-in.com/de/demo/app/">https://aviator-log-in.com/de/demo/app/</a>. Dann befolgen Sie die Schritte unten, beginnend mit der ⋯-Taste.',
		...
		'step1_img_alt' => '⋯-Schaltfläche in Safari auf der Aviator-Demo',
	...
	'es' => array(
		...
		'quick_lead' => 'Abre la demo a pantalla completa en Safari, p. ej. <a href="https://aviator-log-in.com/es/demo/app/">https://aviator-log-in.com/es/demo/app/</a>. Luego siga los pasos de abajo, empezando por el botón ⋯.',
		'step1_title' => 'Paso 1 — botón ⋯',
		'step1_body' => 'Toca el botón <strong>⋯</strong> (tres puntos) en la barra de Safari.',
		'step1_img_alt' => 'Botón ⋯ en Safari en la página demo de Aviator',
	...
	'pt' => array(
		...
		'quick_lead' => 'Abra a demo em ecrã inteiro no Safari, ex.: <a href="https://aviator-log-in.com/pt/demo/app/">https://aviator-log-in.com/pt/demo/app/</a>. Depois siga os passos abaixo, começando pelo botão ⋯.',
		'step1_title' => 'Passo 1 — botão ⋯',
		'step1_body' => 'Toque no botão <strong>⋯</strong> (três pontos) na barra do Safari.',
		'step1_img_alt' => 'Botão ⋯ no Safari na página demo Aviator',
	...
	'ru' => array(
		...
		'quick_lead' => 'Откройте в Safari полноэкранное демо — <a href="https://aviator-log-in.com/ru/demo/app/">https://aviator-log-in.com/ru/demo/app/</a>. Дальше следуйте шагам ниже, начиная с кнопки ⋯.',
		'step1_title' => 'Шаг 1. Кнопка ⋯',
		'step1_body' => 'Нажмите кнопку с <strong>⋯</strong> (тремя точками) в панели Safari.',
		'step1_img_alt' => 'Кнопка ⋯ на странице демо Aviator в Safari',
	...
	'it' => array(
		...
		'quick_lead' => 'Apri la demo a schermo intero in Safari, ad es. <a href="https://aviator-log-in.com/it/demo/app/">https://aviator-log-in.com/it/demo/app/</a>. Poi segui i passi sotto, partendo dal pulsante ⋯.',
		'step1_title' => 'Passo 1 — pulsante ⋯',
		'step1_body' => 'Tocca il pulsante <strong>⋯</strong> (tre puntini) nella barra di Safari.',
		'step1_img_alt' => 'Pulsante ⋯ in Safari sulla demo Aviator',
	...
	'pl' => array(
		...
		'quick_lead' => 'Otwórz pełnoekranowe demo w Safari, np. <a href="https://aviator-log-in.com/pl/demo/app/">https://aviator-log-in.com/pl/demo/app/</a>. Potem wykonaj kroki poniżej, zaczynając od przycisku ⋯.',
		'step1_title' => 'Krok 1 — przycisk ⋯',
		'step1_body' => 'Stuknij przycisk <strong>⋯</strong> (trzy kropki) na pasku Safari.',
		'step1_img_alt' => 'Przycisk ⋯ w Safari na stronie dema Aviator',
	...
	'uk' => array(
		...
		'quick_lead' => 'Відкрийте в Safari повноекранне демо — <a href="https://aviator-log-in.com/ua/demo/app/">https://aviator-log-in.com/ua/demo/app/</a>. Далі кроки нижче, починаючи з кнопки ⋯.',
		'step1_title' => 'Крок 1. Кнопка ⋯',
		'step1_body' => 'Натисніть кнопку з <strong>⋯</strong> (трьома крапками) на панелі Safari.',
		'step1_img_alt' => 'Кнопка ⋯ на демо Aviator у Safari',
	...
	'nl' => array(
		...
		'quick_lead' => 'Open de demo in vol scherm in Safari, bijv. <a href="https://aviator-log-in.com/nl/demo/app/">https://aviator-log-in.com/nl/demo/app/</a>. Volg daarna de stappen hieronder, beginnend met de ⋯-knop.',
		'step1_title' => 'Stap 1 — ⋯-knop',
		'step1_body' => 'Tik op de knop <strong>⋯</strong> (drie puntjes) in de Safari-werkbalk.',
		'step1_img_alt' => '⋯-knop in Safari op de Aviator-demo',
	...
	'ro' => array(
		...
		'quick_lead' => 'Deschide demo pe tot ecranul în Safari, de ex. <a href="https://aviator-log-in.com/ro/demo/app/">https://aviator-log-in.com/ro/demo/app/</a>. Apoi urmați pașii de mai jos, începând cu butonul ⋯.',
		'step1_title' => 'Pasul 1 — buton ⋯',
		'step1_body' => 'Atinge butonul <strong>⋯</strong> (trei puncte) din bara Safari.',
		'step1_img_alt' => 'Buton ⋯ în Safari pe pagina demo Aviator',
	...
	'hi' => array(
		...
		'quick_lead' => 'Safari में फुलस्क्रीन डेमो खोलें, जैसे <a href="https://aviator-log-in.com/hi/demo/app/">https://aviator-log-in.com/hi/demo/app/</a>. फिर नीचे दिए चरणों का पालन करें, ⋯ बटन से शुरू करें।',
		'step1_title' => 'चरण 1 — ⋯ बटन',
		'step1_body' => 'Safari की टूलबार में <strong>⋯</strong> (तीन बिंदु) बटन दबाएँ।',
		'step1_img_alt' => 'Safari में ⋯ बटन, Aviator डेमो पेज पर',
	...
	'ar' => array(
		...
		'quick_lead' => 'افتح التجربة بملء الشاشة في Safari، مثلاً <a href="https://aviator-log-in.com/ar/demo/app/">https://aviator-log-in.com/ar/demo/app/</a>. ثم اتبع الخطوات أدناه، بدءاً من زر ⋯.',
		'step1_title' => 'الخطوة 1 — زر ⋯',
		'step1_body' => 'اضغط زر <strong>⋯</strong> (ثلاث نقاط) في شريط Safari.',
		'step1_img_alt' => 'زر ⋯ في Safari على صفحة تجربة Aviator',
	...
	'bn' => array(
		...
		'quick_lead' => 'Safari-তে ফুলস্ক্রিন ডেমো খুলুন, যেমন <a href="https://aviator-log-in.com/bn/demo/app/">https://aviator-log-in.com/bn/demo/app/</a>. তারপর নিচের ধাপগুলো অনুসরণ করুন, ⋯ বোতাম দিয়ে শুরু করে।',
		'step1_title' => 'ধাপ ১ — ⋯ বোতাম',
		'step1_body' => 'Safari-এর টুলবারে <strong>⋯</strong> (তিনটি বিন্দু) বোতামে ট্যাপ করুন।',
		'step1_img_alt' => 'Safari-তে ⋯ বোতাম, Aviator ডেমো পৃষ্ঠায়',
	...
	'vi' => array(
		...
		'quick_lead' => 'Mở demo toàn màn hình trong Safari, ví dụ <a href="https://aviator-log-in.com/vi/demo/app/">https://aviator-log-in.com/vi/demo/app/</a>. Sau đó làm theo các bước bên dưới, bắt đầu bằng nút ⋯.',
		'step1_title' => 'Bước 1 — nút ⋯',
		'step1_body' => 'Chạm nút <strong>⋯</strong> (ba chấm) trên thanh công cụ Safari.',
		'step1_img_alt' => 'Nút ⋯ trong Safari trên trang demo Aviator',
	...
	'az' => array(
		...
		'quick_lead' => 'Safari-də tam ekran demonu açın, məs. <a href="https://aviator-log-in.com/az/demo/app/">https://aviator-log-in.com/az/demo/app/</a>. Sonra aşağıdakı addımları ⋯ düyməsindən başlayaraq edin.',
		'step1_title' => 'Addım 1 — ⋯ düyməsi',
		'step1_body' => 'Safari panelində <strong>⋯</strong> (üç nöqtə) düyməsinə toxunun.',
		'step1_img_alt' => 'Safari-də ⋯ düyməsi, Aviator demo səhifəsində',
