...
if ($__static_path === '/assets/images/ice-fish-hero.png') {
	header('HTTP/1.1 301 Moved Permanently');
	header('Location: /assets/images/ice-fish-hero.webp');
	exit;
}
...
require_once(ROOT_DIR.'functions/icefish_legacy_slugs.php');	// Aviator slug → Ice Fish redirects
...
// Legacy Aviator guide slugs → Ice Fish slugs (flat or /guides/).
if (function_exists('icefish_legacy_slug_redirect_if_needed')) {
	icefish_legacy_slug_redirect_if_needed($norm_path, $request_url);
}
// Legacy Aviator casino slugs → ice-fish articles or /casinos/ landing.
if (function_exists('icefish_casino_legacy_redirect_if_needed')) {
	icefish_casino_legacy_redirect_if_needed($norm_path, $request_url);
}
...
// Paths without /{lang}/ prefix → 302 to /{resolved}/{path}/ (download, demo/app, casinos, …)
