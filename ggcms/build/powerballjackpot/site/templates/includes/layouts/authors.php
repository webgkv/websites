            ...
            <article class="author-profile">
                <div class="row align-items-start mb-4">
                    <div class="col-md-3 text-center mb-4 mb-md-0">
                        <div class="author-photo-wrapper author-profile-photo d-inline-block rounded-circle overflow-hidden">
                            <?php if ($photo !== '') : ?>
                    ...
                    <div class="col-md-9">
                        ...
                        <?php if (!empty($author['job_title'])) : ?>
                            <p class="text-uppercase mb-3 author-profile-role"><?= htmlspecialchars((string)$author['job_title'], ENT_QUOTES, 'UTF-8') ?></p>
                        <?php endif; ?>
                        <?php if ($profiles) : ?>
