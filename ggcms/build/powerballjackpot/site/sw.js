...
/* PowerBall Jackpot — minimal PWA service worker (offline shell + asset cache). */
const STATIC_CACHE = 'powerballjackpot-static-v1';
				...
				return Promise.all(
					keys
						.filter(function (key) {
							...
							return key.indexOf('powerballjackpot-static-') === 0 && key !== STATIC_CACHE;
						})
						.map(function (key) {
