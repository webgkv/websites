...
function blog_promo_random() {
	...
	$images = array(
		array('src' => function_exists('site_brand_hero_image_path') ? site_brand_hero_image_path() : '/assets/images/chickenroad-hero.webp', 'alt' => (function_exists('site_brand_name') ? site_brand_name() : 'PowerBall Jackpot') . ' preview'),
		array('src' => function_exists('site_brand_hero_image_path') ? site_brand_hero_image_path() : '/assets/images/chickenroad-hero.webp', 'alt' => (function_exists('site_brand_name') ? site_brand_name() : 'PowerBall Jackpot') . ' games'),
	...
	$buttons_html = '<div class="blog-promo-btns btn-area mt-4">'
		. '<a href="' . htmlspecialchars($btn1['href']) . '" class="cmn-btn">' . htmlspecialchars($btn1['text']) . '</a> '
		. '<a href="' . htmlspecialchars($btn2['href']) . '" class="cmn-btn alt">' . htmlspecialchars($btn2['text']) . '</a>'
		. '</div>'
		. '<br>';
