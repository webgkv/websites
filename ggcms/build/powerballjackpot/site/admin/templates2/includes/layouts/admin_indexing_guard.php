...
?>
<li class="nav-item d-flex align-items-center mr-2" id="pbj-admin-index-guard-badge-wrap">
	<span class="badge badge-warning text-dark px-2 py-1" id="pbj-admin-index-guard-badge"
		title="Search indexing is restricted on the public site"
