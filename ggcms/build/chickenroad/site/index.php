...
// Legacy Aviator guide slugs → Chicken Road slugs (flat or /guides/).
if (function_exists('chickenroad_legacy_slug_redirect_if_needed')) {
	chickenroad_legacy_slug_redirect_if_needed($norm_path, $request_url);
}
// Legacy Aviator casino slugs → chicken-road articles or /casinos/ landing.
if (function_exists('chickenroad_casino_legacy_redirect_if_needed')) {
	chickenroad_casino_legacy_redirect_if_needed($norm_path, $request_url);
}
