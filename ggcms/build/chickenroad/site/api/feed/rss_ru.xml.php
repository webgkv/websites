...
//available at /api/feed/rss_ru.xml
...
$config['cache'] = false;
//$cache = 24 * 60 * 60; // one day
$cache = 0;
$file = ROOT_DIR . '/api/feed/rss_ru.xml';
$lang=3;

// Skip if no generation requested or cache still valid
...
$content.='<channel><title><![CDATA[Chicken Road Blog]]></title><description><![CDATA[Chicken Road Blog]]></description><link>'.$rss_domain.'/'.$lang['url'].'/'.$modules['blog'].'/</link><image><url>'.$rss_domain.'/assets/images/logo.webp</url><title>Chicken Road Blog</title><link>'.$rss_domain.'/'.$lang['url'].'/'.$modules['blog'].'/</link></image>';
$content.='<generator>RSS for Node</generator><lastBuildDate>'.gmdate('D, j M Y H:i:s', time()-60*60).' GMT'.'</lastBuildDate><atom:link href="'.$rss_domain.'/api/feed/rss_ru.xml" rel="self" type="application/rss+xml"/><language><![CDATA[ru-RU]]></language>';
