...
$content.='<channel><title><![CDATA[Ice Fish Blog]]></title><description><![CDATA[Ice Fish Blog]]></description><link>'.$rss_domain.'/'.$lang['url'].'/'.$modules['blog'].'/</link><image><url>'.$rss_domain.'/assets/images/logo.webp</url><title>Ice Fish Blog</title><link>'.$rss_domain.'/'.$lang['url'].'/'.$modules['blog'].'/</link></image>';
