    ...
    "@graph": [
        {
            ...
            "publisher": {
                "@type": "Organization",
                "name": "<?= htmlspecialchars(function_exists('site_brand_name') ? site_brand_name() : 'Ice Fish', ENT_QUOTES, 'UTF-8') ?>",
                "logo": {
                    "@type": "ImageObject",
        ...
        { "@type": "WebSite", "name": "<?= htmlspecialchars(function_exists('site_brand_name') ? site_brand_name() : 'Ice Fish', ENT_QUOTES, 'UTF-8') ?>", "url": "https://<?=$_SERVER['HTTP_HOST']?>/", "potentialAction": { "@type": "SearchAction", "target": "https://<?=$_SERVER['HTTP_HOST']?>/search/?q={search_term_string}", "query-input": "required name=search_term_string" }, "sameAs": [] }
    ]
}</script>
