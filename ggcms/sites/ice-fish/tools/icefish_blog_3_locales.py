...
_EN_BODY = {
    ...
    "h2_crash": "Crash games like Ice Fish",
    "img_crash_alt": "Crash games like Ice Fish with instant real-money payouts",
    "crash_p1_pre": "An example of a game that pays real money with the most transparent and easy-to-understand mechanics is ",
    "crash_p1_anchor": "Ice Fish",
    ...
    "partners": [
        ("Mostbet", "InOut's original hit, Ice Fish, is available right in the lobby, along with a trial version, a fully functional mobile app, and welcome bonuses;"),
        ...
        ("Fan-Sport", "the Ice Fish game is easy to find via the internal slot search; a demo version and optimised mobile software are available;"),
        ("1win", "the Ice Fish game is currently unavailable, but the lobby features high-quality crash game alternatives from Turbo Games;"),
    ],
    ...
    "safe_p1": "To play Ice Fish safely, choose only the original version on licensed partners’ websites. Before playing games that pay real money, it’s a good idea to play a few rounds in demo mode to get comfortable with the mechanics. Always keep track of your balance, set session limits in advance, and verify the fairness of the results using the built-in Provably Fair system.",
    "safe_p2_pre": "To ",
    "safe_p2_anchor": "play Ice Fish safely",
    ...
    "safe_p3_anchor": "get the Ice Fish app",
    ...
    "faq": [
        ...
        ("What's the safest real-money game to start with?", "The safest choice is a provably fair title like Ice Fish at a licensed casino. Starting with the demo version lets you master the mechanics safely."),
    ],
}
