# -*- coding: utf-8 -*-
"""Natural Polish, Ukrainian, and Romanian body copy for Ice Fish demo page."""
...
def _pl() -> dict:
    return {
        "intro_h2": "Ice Fish Demo — graj za darmo bez ryzyka",
        "intro_paras": [
            "Ice Fish stała się popularna, bo na początku nie zmusza gracza do długiego zastanawiania się. Otwierasz grę i niemal od razu rozumiesz, o co chodzi. Bez klasycznego chaosu slotów, bez kręcących się bębnów i mylących symboli. Wygląda jak mała gra zręcznościowa, ale każdy kolejny krok nadal niesie ryzyko.",
            "Dlatego Ice Fish tak dobrze działa. Bardziej przypomina grę arcade niż klasyczny tytuł kasynowy. Widzisz kurczaka, drogę, samochody — a główna decyzja jest zawsze jasna: zostać przy obecnym wyniku czy spróbować jeszcze jednego kroku.",
            ...
            "Darmowa wersja na naszej stronie służy właśnie temu — żebyś sam wypróbował Ice Fish. Otwórz demo, graj na wirtualnym saldzie, testuj mechanikę i ciesz się grą bez wydawania ani grosza.",
            "To dobry sposób, by zrozumieć, dlaczego gra stała się tak popularna, zanim przejdziesz do gry na prawdziwe pieniądze.",
        ],
        "what_h2": "Czym jest tryb demo Ice Fish?",
        "what_paras": [
            "Ice Fish Demo to darmowa wersja gry. Grasz na wirtualnym saldzie, a nie na prawdziwe pieniądze. O to chodzi. Możesz otworzyć grę, postawić zakład testowy, wybrać poziom trudności i obserwować, jak kurczak idzie po drodze, bez obawy o utratę własnych środków. Pomyłka? Nic strasznego — tracisz tylko kredyty demo i zaczynasz od nowa.",
            "Demo to nie inna gra. Działa prawie tak samo jak pełna wersja. Kurczak nadal idzie krok po kroku, mnożnik rośnie po każdym bezpiecznym ruchu, a Ty wciąż musisz zdecydować, kiedy się zatrzymać. Wypłacić teraz czy zaryzykować jeszcze jeden krok — w tym całe napięcie Ice Fish.",
            ...
            "Prawdziwe pieniądze zmieniają wszystko. Ten sam krok odczuwasz inaczej, gdy na szali jest Twoje własne saldo. Używaj Ice Fish Demo tak, jak do tego służy — poznaj grę, przetestuj przyciski i zrozum ryzyko, zanim pomyślisz o prawdziwych zakładach.",
        ],
        "start_h2": "Jak uruchomić demo Ice Fish",
        "start_steps": [
            "Uruchomienie demo Ice Fish jest proste. Jeśli chcesz, pobierz i zainstaluj aplikację — po instalacji ją otwórz. Możesz też grać od razu w przeglądarce na stronie naszego serwisu.",
        ...
        "why_before": [
            "Demo to najbezpieczniejszy sposób, by zrozumieć Ice Fish, zanim użyjesz prawdziwych pieniędzy. Można się tu pomylić — o to właśnie chodzi.",
        ...
        "mobile_h2": "Demo Ice Fish na telefonie",
        "mobile_paras": [
            "Demo Ice Fish świetnie działa na telefonie. Gra jest prosta i nie wymaga ogromnego ekranu. Otwierasz ją, widzisz kurczaka, drogę, kwotę zakładu i główne przyciski — to wystarczy.",
            ...
            "Możesz grać w demo prosto z przeglądarki. Aplikacja nie jest konieczna, ale dla szybszego dostępu użyj skrótu z naszej strony. Doda ikonę Ice Fish Demo na ekran główny, żeby następnym razem nie szukać strony od nowa.",
        ],
        "download_h2": "Czy trzeba pobierać demo Ice Fish?",
        "download_paras": [
            "Do gry w demo Ice Fish pobieranie nie jest konieczne. Demo działa w przeglądarce — otwierasz je w sieci i od razu grasz na wirtualnym saldzie.",
            "Na naszej stronie może być też szybki dostęp przez skrót aplikacji lub PWA. Na telefonie wygląda i działa jak aplikacja, ale demo nadal działa przez stronę. Chodzi o wygodę: dotykasz ikony i szybciej otwierasz Ice Fish, bez szukania strony.",
            "Uważaj na losowe pliki APK z innych serwisów. Jeśli jakaś strona oferuje „specjalny APK Ice Fish”, „zhakowaną wersję” lub „aplikację-predictor”, lepiej ją pominąć. Takie pliki mogą być podróbką i czasem służą tylko do zbierania danych albo prowadzą na niebezpieczne strony.",
            "Do zwykłej gry w demo wystarczy wersja przeglądarkowa. Otwórz stronę, uruchom grę i przetestuj Ice Fish bez ryzykownej instalacji.",
        ],
        "trouble_h2": "Jeśli demo Ice Fish nie uruchamia się",
        "trouble_paras": [
            ...
            "Blokery reklam też mogą psuć stronę. Niektóre przez pomyłkę blokują skrypty gry. Wyłącz blokadę dla tej strony albo spróbuj trybu prywatnego. I sprawdź internet: demo Ice Fish nie jest ciężkie, ale słaby sygnał może zostawić grę na ładowaniu przed pierwszą rundą.",
        ],
        "safety_h2": "Bezpieczeństwo demo i uczciwa gra",
        "safety_paras": [
            "Ice Fish Demo powstało po to, by wypróbować grę, zanim użyjesz prawdziwych pieniędzy. Otwierasz ją, grasz na wirtualnym saldzie, testujesz przyciski i patrzysz, jak działa runda. Tylko tyle powinno robić demo.",
            ...
            "Uważaj na strony, które używają nazwy Ice Fish, ale obiecują „gwarantowane wygrane”, „tajne przewidywanie” lub „specjalne demo z prawdziwymi wypłatami”. Zwykłe demo tak nie działa. Korzysta z wirtualnych kredytów, a każdy wynik w demo zostaje w demo.",
            "Prosta zasada: jeśli to naprawdę darmowe demo, nie powinno prosić o pieniądze.",
        ],
        "faq_h2": "FAQ — demo Ice Fish",
        "faq": [
            (
                "Czy mogę grać w Ice Fish Demo za darmo?",
            ...
            (
                "Czy Ice Fish Demo działa na telefonie?",
            ...
            (
                ...
                "Nie. Z góry nie wiadomo, co stanie się przy następnym ruchu. Do każdej aplikacji lub strony z „przewidywaniami Ice Fish” warto podchodzić ostrożnie.",
            ),
            (
            ...
            (
                "Czy to oficjalna gra Ice Fish?",
                "Ice Fish została opracowana przez InOut Games. Demo na naszej stronie służy do ćwiczeń i poznania gry. Nasz serwis nie jest oficjalną stroną InOut Games.",
            ),
        ],
        "titles": {
        ...
        "alts": {
            "gameplay": "Rozgrywka demo Ice Fish z mnożnikiem na ekranie",
            "app": "Demo Ice Fish na telefonie i komputerze",
            "mobile": "Mobilny interfejs Ice Fish w trybie pionowym",
            "interface": "Interfejs Ice Fish na różnych urządzeniach",
            "step1": "Krok 1: otwórz demo Ice Fish",
            "step2": "Krok 2: wybierz trudność i zakład",
            "step3": "Krok 3: wypłata w demo Ice Fish",
        },
    }
...
def _ua() -> dict:
    return {
        "intro_h2": "Ice Fish Demo — грайте безкоштовно без ризику",
        "intro_paras": [
            "Ice Fish стала популярною, бо на початку не змушує гравця довго думати. Ви відкриваєте гру й майже одразу розумієте ідею. Без класичного хаосу слотів, барабанів і заплутаних символів. Це схоже на невелику аркаду, але кожен наступний крок усе одно несе ризик.",
            "Ось чому Ice Fish так добре працює. Вона більше нагадує аркаду, ніж класичну казино-гру. Ви бачите курку, дорогу, машини — і головне рішення завжди зрозуміле: залишитися з поточним результатом чи спробувати ще один крок.",
            ...
            "Безкоштовна версія на нашому сайті якраз для цього — щоб ви самі спробували Ice Fish. Відкрийте демо, грайте на віртуальний баланс, тестуйте механіку й насолоджуйтесь процесом, не витрачаючи ні цента.",
            "Це хороший спосіб зрозуміти, чому гра стала такою популярною, перш ніж переходити до гри на реальні гроші.",
        ],
        "what_h2": "Що таке демо-режим Ice Fish?",
        "what_paras": [
            "Ice Fish Demo — безкоштовна версія гри. Ви граєте на віртуальний баланс, а не на реальні гроші. У цьому весь сенс. Можна відкрити гру, поставити тестову ставку, вибрати рівень складності й подивитися, як курка рухається дорогою, не боячись втратити власні кошти. Помилилися — нічого страшного: втрачаються лише демо-кредити, і ви починаєте знову.",
            "Демо — це не інша гра. Вона працює майже так само, як повна версія. Курка йде крок за кроком, множник зростає після кожного безпечного ходу, і вам усе одно потрібно вирішувати, коли зупинитися. Забрати виграш зараз чи ризикнути ще одним кроком — у цьому вся напруга Ice Fish.",
            ...
            "З реальними грошима все інакше. Той самий крок відчувається по-іншому, коли на кону ваш власний баланс. Використовуйте Ice Fish Demo за призначенням — вивчайте гру, тестуйте кнопки й розумійте ризик, перш ніж думати про реальні ставки.",
        ],
        "start_h2": "Як запустити демо Ice Fish",
        "start_steps": [
            "Запустити демо Ice Fish просто. За бажанням завантажте й установіть застосунок — після встановлення відкрийте його. Також можна грати прямо в браузері на сторінці нашого сайту.",
        ...
        "why_before": [
            "Демо — найбезпечніший спосіб зрозуміти Ice Fish, перш ніж використовувати реальні гроші. Там можна помилятися — у цьому й сенс.",
        ...
        "mobile_h2": "Демо Ice Fish на мобільному",
        "mobile_paras": [
            "Демо Ice Fish чудово працює на телефоні. Гра проста, їй не потрібен величезний екран. Ви відкриваєте її, бачите курку, дорогу, суму ставки й основні кнопки — цього достатньо.",
            ...
            "Можна грати в демо прямо з браузера. Застосунок не обов’язковий, але для швидшого доступу скористайтеся ярликом з нашого сайту. Він додасть іконку Ice Fish Demo на головний екран, і наступного разу не доведеться знову шукати сторінку.",
        ],
        "download_h2": "Чи потрібно завантажувати демо Ice Fish?",
        "download_paras": [
            "Для гри в демо Ice Fish завантаження не обов’язкове. Демо працює через веб — можна відкрити його в браузері й одразу грати на віртуальний баланс.",
            "На нашому сайті також може бути швидкий доступ через ярлик застосунку або PWA. На телефоні це виглядає й відчувається як застосунок, але демо все одно працює через сайт. Головне — зручність: натиснули іконку й швидше відкрили Ice Fish, без пошуку сторінки.",
            "Обережніше з випадковими APK з інших сайтів. Якщо якась сторінка пропонує «особливий Ice Fish APK», «зламану версію» або «застосунок-передбачувач», краще пропустити. Такі файли можуть бути підробкою й іноді створені лише для збору даних або переведення на небезпечні сторінки.",
            "Для звичайної гри в демо достатньо браузерної версії. Відкрийте сторінку, запустіть гру й протестуйте Ice Fish без ризикованого встановлення.",
        ],
        "trouble_h2": "Якщо демо Ice Fish не запускається",
        "trouble_paras": [
            ...
            "Блокувальник реклами теж може ламати сторінку. Деякі помилково блокують ігрові скрипти. Вимкніть його для цієї сторінки або спробуйте приватний режим. І перевірте інтернет: демо Ice Fish не важке, але слабкий сигнал усе одно може залишити гру на завантаженні до першого раунду.",
        ],
        "safety_h2": "Безпека демо та чесна гра",
        "safety_paras": [
            "Ice Fish Demo створено для одного — щоб ви спробували гру до використання реальних грошей. Ви відкриваєте її, граєте на віртуальний баланс, тестуєте кнопки й дивитеся, як працює раунд. Демо має робити лише це.",
            ...
            "Обережніше зі сторінками, які використовують назву Ice Fish, але обіцяють «гарантовані виграші», «таємне передбачення» або «особливе демо з реальними виплатами». Звичайне демо так не працює. Воно використовує віртуальні кредити, і будь-який результат у демо залишається в демо.",
            "Просте правило: якщо це справді безкоштовне демо, воно не повинно просити гроші.",
        ],
        "faq_h2": "FAQ — демо Ice Fish",
        "faq": [
            (
                "Чи можна грати в Ice Fish Demo безкоштовно?",
            ...
            (
                "Чи працює Ice Fish Demo на мобільному?",
            ...
            (
                ...
                "Ні. Заздалегідь не можна знати, що станеться на наступному ході. Будь-який застосунок або сайт із «передбаченнями Ice Fish» варто сприймати обережно.",
            ),
            (
            ...
            (
                "Це офіційна гра Ice Fish?",
                "Ice Fish розроблена InOut Games. Демо на нашому сайті доступне для практики й знайомства з грою. Наш сайт не є офіційним сайтом InOut Games.",
            ),
        ],
        "titles": {
        ...
        "alts": {
            "gameplay": "Демо-геймплей Ice Fish із множником на екрані",
            "app": "Демо Ice Fish на телефоні та комп’ютері",
            "mobile": "Мобільний інтерфейс Ice Fish у портретному режимі",
            "interface": "Інтерфейс Ice Fish на різних пристроях",
            "step1": "Крок 1: відкрити демо Ice Fish",
            "step2": "Крок 2: вибрати складність і ставку",
            "step3": "Крок 3: виведення виграшу в демо Ice Fish",
        },
    }
...
def _ro() -> dict:
    return {
        ...
        "intro_paras": [
            "Ice Fish a devenit populară pentru că la început nu te obligă să te gândești prea mult. Deschizi jocul și înțelegi ideea aproape imediat. Fără haosul clasic al sloturilor, fără role care se învârt, fără simboluri confuze. Arată ca un arcade mic, dar fiecare pas următor poartă totuși risc.",
            "De aceea Ice Fish funcționează atât de bine. Se simte mai degrabă ca un joc arcade decât ca un titlu clasic de cazino. Vezi găina, drumul, mașinile — iar decizia principală rămâne clară: păstrezi rezultatul actual sau încerci încă un pas.",
            ...
            "Versiunea gratuită de pe site-ul nostru e făcută exact pentru asta — să încerci Ice Fish pe cont propriu. Deschizi demo-ul, joci cu sold virtual, testezi mecanica și te bucuri de joc fără să cheltui un cent.",
        ...
        "what_paras": [
            ...
            "Demo-ul nu e alt joc. Funcționează aproape la fel ca versiunea completă. Găina merge pas cu pas, multiplicatorul crește după fiecare pas sigur și tot trebuie să decizi când te oprești. Cash out acum sau încă un pas — asta e toată tensiunea Ice Fish.",
            ...
            "Banii reali schimbă totul. Același pas se simte diferit când pe masă e propriul tău sold. Folosește Ice Fish Demo pentru ce face bine — învață jocul, testează butoanele și înțelege riscul înainte să te gândești la pariuri reale.",
        ],
        "start_h2": "Cum pornești demo-ul Ice Fish",
        "start_steps": [
            "Pornirea demo-ului Ice Fish e simplă. Dacă vrei, descarcă și instalează aplicația — după instalare o deschizi. Poți juca și direct în browser pe pagina site-ului nostru.",
        ...
        "mobile_h2": "Demo Ice Fish pe mobil",
        "mobile_paras": [
            "Demo-ul Ice Fish merge bine pe telefon. Jocul e simplu și nu are nevoie de ecran uriaș. Îl deschizi, vezi găina, drumul, suma pariului și butoanele principale — e suficient.",
            ...
            "Poți juca demo-ul direct din browser. Aplicația nu e obligatorie, dar pentru acces mai rapid folosește scurtătura de pe site-ul nostru. Adaugă iconița Ice Fish Demo pe ecranul principal, ca data viitoare să nu cauți pagina.",
        ],
        "download_h2": "Trebuie să descarci demo-ul Ice Fish?",
        "download_paras": [
            "Nu e nevoie să descarci Ice Fish Demo ca să joci. Demo-ul merge prin web — îl deschizi în browser și joci imediat cu sold virtual.",
            "Pe site-ul nostru poate exista și acces rapid printr-o scurtătură de tip app sau PWA. Pe telefon arată și se simte ca o aplicație, dar demo-ul tot rulează prin site. Ideea e confortul: atingi iconița și deschizi Ice Fish mai repede, fără să cauți pagina.",
            "Ai grijă la fișiere APK aleatoare de pe alte site-uri. Dacă o pagină oferă «APK special Ice Fish», «versiune hack» sau «app predictor», mai bine sari peste. Fișierele pot fi false și uneori sunt făcute doar să colecteze date sau să ducă pe pagini nesigure.",
            "Pentru joc demo obișnuit, versiunea din browser e suficientă. Deschide pagina, lansează jocul și testează Ice Fish fără instalări riscante.",
        ],
        "trouble_h2": "Dacă demo-ul Ice Fish nu pornește",
        "trouble_paras": [
        ...
        "safety_paras": [
            ...
            "Ai grijă la pagini care folosesc numele Ice Fish dar promit «câștiguri garantate», «predicție secretă» sau «demo special cu plăți reale». Un demo normal nu funcționează așa — folosește credite virtuale, iar orice rezultat rămâne în demo.",
            "Regulă simplă: dacă e cu adevărat demo gratuit, nu ar trebui să ceară bani.",
        ],
        "faq_h2": "FAQ — demo Ice Fish",
        "faq": [
            (
                "Pot juca Ice Fish Demo gratuit?",
            ...
            (
                ...
                "Nu. Nu poți ști dinainte ce se întâmplă la mutarea următoare. Orice app sau site care promite «predicții Ice Fish» merită tratat cu prudență.",
            ),
            (
            ...
            (
                "Acesta e jocul oficial Ice Fish?",
                "Ice Fish e dezvoltat de InOut Games. Demo-ul de pe site-ul nostru e pentru practică și familiarizare. Site-ul nostru nu e site-ul oficial InOut Games.",
            ),
        ],
        "titles": {
        ...
        "alts": {
            ...
            "app": "Demo Ice Fish pe telefon și computer",
            "mobile": "Interfața mobilă Ice Fish în mod portret",
            "interface": "Interfața Ice Fish pe mai multe dispozitive",
            "step1": "Pasul 1: deschide demo Ice Fish",
            "step2": "Pasul 2: alege dificultatea și pariul",
            "step3": "Pasul 3: cash out în demo Ice Fish",
        },
    }
