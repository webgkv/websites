#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Rebuild casino_articles#25 Jack-Pot Ice Fish cluster — clean HTML + locale translations."""
...
from icefish_casino_articles_25_locales import IMAGES, LOCALE_META, get_body  # noqa: E402
...
def main() -> None:
    ...
    for lang_id, meta in LOCALE_META.items():
        ...
        loc = {
            ...
            "url": meta.get("url", "jack-pot-ice-fish"),
            "name": meta["name"],
            "title": meta["title"],
