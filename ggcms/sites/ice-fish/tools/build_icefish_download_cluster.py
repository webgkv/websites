...
from icefish_download_full_locales import get_all_full_locales
from icefish_download_full_ru import get_russian
from icefish_download_html_extract import extract_english
...
IMAGES = {
    "hero": "/assets/images/ice-fish-download-hero.webp",
...
LOCALE_META = {
    1: {
        "code": "en",
        "name": "Download",
        "title": "Ice Fish App Download: Android, iPhone and PC",
        "description": "Download the Ice Fish demo app for Android and iPhone, check system requirements, and learn how the shortcut works before real-money play.",
    },
    3: {
        "code": "fr",
        "name": "Télécharger",
        "title": "Télécharger Ice Fish : Android, iPhone et PC",
        "description": "Téléchargez l’app démo Ice Fish sur Android et iPhone, consultez les prérequis et découvrez le raccourci avant le jeu en argent réel.",
    },
    4: {
        "code": "de",
        "name": "Download",
        "title": "Ice Fish App: Download für Android, iPhone und PC",
        "description": "Laden Sie die Ice-Fish-Demo-App für Android und iPhone herunter, prüfen Sie die Systemanforderungen und testen Sie den Shortcut.",
    },
    6: {
        "code": "es",
        "name": "Descargar",
        "title": "Descargar Ice Fish: Android, iPhone y PC",
        "description": "Descarga la app demo de Ice Fish en Android e iPhone, revisa requisitos del sistema y prueba el acceso directo antes de jugar con dinero real.",
    },
    7: {
        "code": "hi",
        "name": "डाउनलोड",
        "title": "Ice Fish ऐप डाउनलोड: Android, iPhone और PC",
        "description": "Android और iPhone के लिए Ice Fish डेमो ऐप डाउनलोड करें, सिस्टम आवश्यकताएँ देखें और असली पैसे से पहले शॉर्टकट आज़माएँ।",
    },
    8: {
        "code": "pt",
        "name": "Download",
        "title": "Download Ice Fish: Android, iPhone e PC",
        "description": "Baixe o app demo do Ice Fish para Android e iPhone, veja requisitos de sistema e teste o atalho antes de jogar com dinheiro real.",
    },
    9: {
        "code": "ru",
        "name": "Скачать",
        "title": "Скачать Ice Fish: Android, iPhone и PC",
        "description": "Скачайте демо-приложение Ice Fish для Android и iPhone, проверьте системные требования и протестируйте быстрый доступ до игры на деньги.",
    },
    11: {
        "code": "ar",
        "name": "تنزيل",
        "title": "تنزيل Ice Fish: Android وiPhone وPC",
        "description": "حمّل تطبيق Ice Fish التجريبي على Android وiPhone، واطّلع على المتطلبات وتعرّف على الاختصار قبل اللعب بمال حقيقي.",
    },
    12: {
        "code": "az",
        "name": "Yüklə",
        "title": "Ice Fish yüklə: Android, iPhone və PC",
        "description": "Android və iPhone üçün Ice Fish demo tətbiqini yükləyin, sistem tələblərinə baxın və real pul oyunundan əvvəl qısayolu sınayın.",
    },
    13: {
        "code": "bn",
        "name": "ডাউনলোড",
        "title": "Ice Fish অ্যাপ ডাউনলোড: Android, iPhone ও PC",
        "description": "Android ও iPhone-এ Ice Fish ডেমো অ্যাপ ডাউনলোড করুন, সিস্টেম চাহিদা দেখুন এবং আসল টাকায় খেলার আগে শর্টকাট চেষ্টা করুন।",
    },
    14: {
        "code": "it",
        "name": "Download",
        "title": "Download Ice Fish: Android, iPhone e PC",
        "description": "Scarica l’app demo Ice Fish per Android e iPhone, controlla i requisiti di sistema e prova la scorciatoia prima del gioco con soldi veri.",
    },
    15: {
        "code": "nl",
        "name": "Download",
        "title": "Ice Fish download: Android, iPhone en PC",
        "description": "Download de Ice Fish demo-app voor Android en iPhone, bekijk systeemvereisten en test de snelkoppeling vóór echt geld spelen.",
    },
    16: {
        "code": "pl",
        "name": "Pobierz",
        "title": "Pobierz Ice Fish: Android, iPhone i PC",
        "description": "Pobierz aplikację demo Ice Fish na Android i iPhone, sprawdź wymagania systemowe i przetestuj skrót przed grą na prawdziwe pieniądze.",
    },
    17: {
        "code": "vi",
        "name": "Tải xuống",
        "title": "Tải Ice Fish: Android, iPhone và PC",
        "description": "Tải app demo Ice Fish cho Android và iPhone, xem yêu cầu hệ thống và thử lối tắt trước khi chơi bằng tiền thật.",
    },
    18: {
        "code": "ua",
        "name": "Завантажити",
        "title": "Завантажити Ice Fish: Android, iPhone та PC",
        "description": "Завантажте демо-додаток Ice Fish для Android і iPhone, перевірте системні вимоги та протестуйте швидкий доступ перед грою на гроші.",
    },
    19: {
        "code": "ro",
        "name": "Descărcare",
        "title": "Descarcă Ice Fish: Android, iPhone și PC",
        "description": "Descarcă aplicația demo Ice Fish pentru Android și iPhone, verifică cerințele de sistem și testează scurtătura înainte de joc pe bani reali.",
    },
}
...
def english_alts() -> dict:
    return {
        "hero": "Ice Fish app download on mobile and desktop",
        "app": "Ice Fish demo app on phone and computer",
        "mobile": "Ice Fish mobile interface in portrait mode",
        "interface": "Ice Fish app interface across devices",
