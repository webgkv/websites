...
from icefish_html_extract import extract_english
...
LOCALE_META = {
    1: {"code": "en", "name": "Home", "title": "Ice Fish Online: How It Works, Demo and Real Money", "description": "Learn how Ice Fish works, why the demo matters, and how to play responsibly before trying real-money rounds."},
    3: {"code": "fr", "name": "Accueil", "title": "Ice Fish en ligne : fonctionnement, démo et argent réel", "description": "Découvrez comment Ice Fish fonctionne, pourquoi la démo compte et comment jouer de façon responsable."},
    4: {"code": "de", "name": "Start", "title": "Ice Fish online: So funktioniert es, Demo und Echtgeld", "description": "Erfahren Sie, wie Ice Fish funktioniert, warum die Demo wichtig ist und wie Sie verantwortungsvoll spielen."},
    6: {"code": "es", "name": "Inicio", "title": "Ice Fish online: cómo funciona, demo y dinero real", "description": "Descubra cómo funciona Ice Fish, por qué importa la demo y cómo jugar con responsabilidad."},
    7: {"code": "hi", "name": "होम", "title": "Ice Fish ऑनलाइन: कैसे काम करता है, डेमो और असली पैसा", "description": "जानें Ice Fish कैसे काम करता है, डेमो क्यों ज़रूरी है और जिम्मेदारी से कैसे खेलें।"},
    8: {"code": "pt", "name": "Início", "title": "Ice Fish online: como funciona, demo e dinheiro real", "description": "Veja como Ice Fish funciona, por que a demo importa e como jogar com responsabilidade."},
    9: {"code": "ru", "name": "Главная", "title": "Ice Fish онлайн: как работает, демо и реальные деньги", "description": "Узнайте, как устроена Ice Fish, зачем нужен демо-режим и как играть ответственно перед ставками на деньги."},
    11: {"code": "ar", "name": "الرئيسية", "title": "Ice Fish أونلاين: كيف تعمل، الديمو والمال الحقيقي", "description": "تعرّف على آلية Ice Fish ولماذا يهم الوضع التجريبي وكيف تلعب بمسؤولية."},
    12: {"code": "az", "name": "Ana səhifə", "title": "Ice Fish onlayn: necə işləyir, demo və real pul", "description": "Ice Fish-un necə işlədiyini, demonun niyə vacib olduğunu və məsuliyyətli oyunu öyrənin."},
    13: {"code": "bn", "name": "হোম", "title": "Ice Fish অনলাইনে: কীভাবে কাজ করে, ডেমো ও আসল টাকা", "description": "Ice Fish কীভাবে কাজ করে, ডেমো কেন গুরুত্বপূর্ণ এবং দায়িত্বশীলভাবে কীভাবে খেলবেন জানুন।"},
    14: {"code": "it", "name": "Home", "title": "Ice Fish online: come funziona, demo e soldi veri", "description": "Scopri come funziona Ice Fish, perché conta la demo e come giocare in modo responsabile."},
    15: {"code": "nl", "name": "Home", "title": "Ice Fish online: zo werkt het, demo en echt geld", "description": "Leer hoe Ice Fish werkt, waarom de demo telt en hoe je verantwoord speelt."},
    16: {"code": "pl", "name": "Strona główna", "title": "Ice Fish online: jak działa, demo i prawdziwe pieniądze", "description": "Dowiedz się, jak działa Ice Fish, po co jest demo i jak grać odpowiedzialnie."},
    17: {"code": "vi", "name": "Trang chủ", "title": "Ice Fish trực tuyến: cách chơi, bản demo và tiền thật", "description": "Tìm hiểu Ice Fish hoạt động thế nào, vì sao bản demo quan trọng và cách chơi có trách nhiệm."},
    18: {"code": "ua", "name": "Головна", "title": "Ice Fish онлайн: як працює, демо та реальні гроші", "description": "Дізнайтеся, як влаштована Ice Fish, навіщо потрібен демо-режим і як грати відповідально."},
    19: {"code": "ro", "name": "Acasă", "title": "Ice Fish online: cum funcționează, demo și bani reali", "description": "Află cum funcționează Ice Fish, de ce contează demo-ul și cum să joci responsabil."},
}
...
<section id="ice-fish-app" class="mt-5 pt-5">
<div class="container">
<div class="col-12">
...
def polish_english(en: dict) -> dict:
    ...
    if len(wp) > 4:
        wp[4] = (
            "Ice Fish launched in 2024 and quickly became one of InOut Games' "
            ...
            "including awards connected to Ice Fish and its wider crash portfolio."
        )
    wk = data["works_paras"]
    if len(wk) > 5:
        wk[5] = (
            "Ice Fish uses a step-based crash mechanic where every successful move "
    ...
    if len(wy) > 3:
        wy[3] = (
            "Ice Fish also has a strong advantage in its original version: the RTP is "
            "listed at 98%, which is high compared to many crash-style games. The first "
            "Ice Fish version combines a 98% RTP with four difficulty levels and a "
