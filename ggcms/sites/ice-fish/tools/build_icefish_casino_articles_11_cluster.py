#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Rebuild casino_articles#11 1xBet Ice Fish cluster — clean HTML + locale translations."""
...
from icefish_casino_articles_11_locales import IMAGES, LOCALE_META, get_body  # noqa: E402
...
def main() -> None:
    ...
    for lang_id, meta in LOCALE_META.items():
        ...
        loc = {
            ...
            "url": meta.get("url", "1xbet-ice-fish"),
            "name": meta["name"],
            "title": meta["title"],
