# -*- coding: utf-8 -*-
"""Structured body + meta for casino_articles#25 Jack-Pot Ice Fish cluster."""
...
LOCALE_META = {
    "1": {
        ...
        "title": "Ice Fish on Jack-Pot: play, demo & mobile tips",
        "description": "Play Ice Fish on Jack-Pot: find InOut games in the lobby, try demo mode, mobile tips, bonuses, licence notes and FAQ.",
        "url": "jack-pot-ice-fish",
    },
    "3": {
        "code": "fr",
        "name": "Jack-Pot — Ice Fish",
        "title": "Ice Fish sur Jack-Pot : jouer, démo et mobile",
        "description": "Jouez à Ice Fish sur Jack-Pot : trouvez InOut dans le lobby, mode démo, mobile, bonus, licence et FAQ.",
        "url": "jack-pot-ice-fish",
    },
    "4": {
        "code": "de",
        "name": "Jack-Pot — Ice Fish",
        "title": "Ice Fish auf Jack-Pot: Spielen, Demo & Mobile",
        "description": "Ice Fish auf Jack-Pot: InOut-Spiele im Lobby finden, Demo, Mobile-Tipps, Boni, Lizenz und FAQ.",
        "url": "jack-pot-ice-fish",
    },
    "6": {
        "code": "es",
        "name": "Jack-Pot — Ice Fish",
        "title": "Ice Fish en Jack-Pot: jugar, demo y móvil",
        "description": "Juega Ice Fish en Jack-Pot: encuentra InOut en el lobby, modo demo, móvil, bonos, licencia y FAQ.",
        "url": "jack-pot-ice-fish",
    },
    "7": {
        "code": "hi",
        "name": "Jack-Pot — Ice Fish",
        "title": "Jack-Pot पर Ice Fish: खेलें, डेमो और मोबाइल",
        "description": "Jack-Pot पर Ice Fish खेलें — InOut गेम खोजें, डेमो, मोबाइल टिप्स, बोनस, लाइसेंस और FAQ।",
        "url": "jack-pot-ice-fish",
    },
    "8": {
        "code": "pt",
        "name": "Jack-Pot — Ice Fish",
        "title": "Ice Fish na Jack-Pot: jogar, demo e mobile",
        "description": "Jogue Ice Fish na Jack-Pot: encontre InOut no lobby, demo, mobile, bônus, licença e FAQ.",
        "url": "jack-pot-ice-fish",
    },
    "9": {
        "code": "ru",
        "name": "Jack-Pot — Ice Fish",
        "title": "Ice Fish на Jack-Pot: игра, демо и мобильная версия",
        "description": "Ice Fish на Jack-Pot: как найти InOut в лобби, демо, мобильные советы, бонусы, лицензия и FAQ.",
        "url": "jack-pot-ice-fish",
    },
    "11": {
        "code": "ar",
        "name": "Jack-Pot — Ice Fish",
        "title": "Ice Fish على Jack-Pot: لعب وديمو وموبايل",
        "description": "العب Ice Fish على Jack-Pot: اعثر على InOut في اللوبي، تجريبي، موبايل، مكافآت، ترخيص وFAQ.",
        "url": "jack-pot-ice-fish",
    },
    "12": {
        "code": "az",
        "name": "Jack-Pot — Ice Fish",
        "title": "Jack-Pot-da Ice Fish: oyun, demo və mobil",
        "description": "Jack-Pot-da Ice Fish oynayın — lobidə InOut tapın, demo, mobil, bonuslar, lisenziya və FAQ.",
        "url": "jack-pot-ice-fish",
    },
    "13": {
        "code": "bn",
        "name": "Jack-Pot — Ice Fish",
        "title": "Jack-Pot-এ Ice Fish: খেলা, ডেমো ও মোবাইল",
        "description": "Jack-Pot-এ Ice Fish খেলুন — লবিতে InOut খুঁজুন, ডেমো, মোবাইল, বোনাস, লাইসেন্স ও FAQ।",
        "url": "jack-pot-ice-fish",
    },
    "14": {
        "code": "it",
        "name": "Jack-Pot — Ice Fish",
        "title": "Ice Fish su Jack-Pot: giocare, demo e mobile",
        "description": "Gioca a Ice Fish su Jack-Pot: trova InOut nel lobby, demo, mobile, bonus, licenza e FAQ.",
        "url": "jack-pot-ice-fish",
    },
    "15": {
        "code": "nl",
        "name": "Jack-Pot — Ice Fish",
        "title": "Ice Fish op Jack-Pot: spelen, demo en mobiel",
        "description": "Speel Ice Fish op Jack-Pot: vind InOut in de lobby, demo, mobiel, bonussen, licentie en FAQ.",
        "url": "jack-pot-ice-fish",
    },
    "16": {
        "code": "pl",
        "name": "Jack-Pot — Ice Fish",
        "title": "Ice Fish na Jack-Pot: gra, demo i mobile",
        "description": "Ice Fish na Jack-Pot: znajdź InOut w lobby, demo, mobile, bonusy, licencja i FAQ.",
        "url": "jack-pot-ice-fish",
    },
    "17": {
        "code": "vi",
        "name": "Jack-Pot — Ice Fish",
        "title": "Ice Fish trên Jack-Pot: chơi, demo và mobile",
        "description": "Chơi Ice Fish trên Jack-Pot: tìm InOut trong lobby, demo, mobile, bonus, giấy phép và FAQ.",
        "url": "jack-pot-ice-fish",
    },
    "18": {
        "code": "ua",
        "name": "Jack-Pot — Ice Fish",
        "title": "Ice Fish на Jack-Pot: гра, демо та мобільна версія",
        "description": "Ice Fish на Jack-Pot: як знайти InOut у лобі, демо, мобільні поради, бонуси, ліцензія та FAQ.",
        "url": "jack-pot-ice-fish",
    },
    "19": {
        "code": "ro",
        "name": "Jack-Pot — Ice Fish",
        "title": "Ice Fish pe Jack-Pot: joc, demo și mobil",
        "description": "Joacă Ice Fish pe Jack-Pot: găsește InOut în lobby, demo, mobil, bonusuri, licență și FAQ.",
        "url": "jack-pot-ice-fish",
    },
}
...
_EN_BODY = {
    ...
    "img_hero_alt": "Jack-Pot online casino lobby and Ice Fish overview",
    "about_paras": [
        ...
        "Ice Fish fits Jack-Pot well because it is exactly the kind of game that needs quick access. Nobody wants to dig through a huge lobby just to find a fast arcade-style game. You open it, set the bet, choose the risk level, and the round starts. For Ice Fish, the main advantage of Jack-Pot is the clean path to the game. Fast lobby, search bar, mobile access, and a layout that does not get in the way. That is enough for a game built around short rounds and quick decisions.",
    ...
    "h2_where": "Where to Find Ice Fish on Jack-Pot",
    "where_paras": [
        "Ice Fish is easy to find on Jack-Pot if you know where to look. Open the casino section and go to Slots or Crash Games. Most fast arcade-style games are usually placed somewhere around these categories.",
        "The quickest way is search. Type Ice Fish in the search bar, wait for the game banner to appear, and open it. The game should launch in a separate window.",
        "You can also search by provider. Enter InOut and Jack-Pot should show games from this studio. This helps if you want to find not only Ice Fish, but other InOut titles too.",
    ...
    "play_paras": [
        ...
        "If this is the original Ice Fish from InOut Games, the basic rules stay the same on Jack-Pot as on other platforms: move forward, grow the multiplier, cash out before losing the round.",
    ],
    "h2_demo": "Demo and Real-Money Play on Jack-Pot",
    "demo_paras": [
        "Ice Fish demo is available on Jack-Pot, and that is where I would start. Not because demo teaches you how to win. It does not. But it lets you see the game without pressure.",
    ...
    "final_paras": [
        ...
        "Jack-Pot gives Ice Fish a clean place to play, especially from mobile. Search works, the lobby is not too heavy, and demo mode is useful if you want to test the mechanics first.",
        "Still, Ice Fish is not a money-making tool. It is a casino game with real risk. Use demo before real-money play, set limits, do not chase losses, and treat every round as entertainment, not income.",
    ],
    "h2_faq": "FAQ",
    "faq": [
        [
        ...
        [
            "Can I find Ice Fish on Jack-Pot?",
            "Yes, if Ice Fish is available in the Jack-Pot game lobby. Search by the game name first. If nothing appears, try the provider name: InOut.",
        ],
        [
...
def get_body(lang_code: str) -> dict:
    ...
    try:
        from icefish_casino_articles_25_overrides import LOCALE_OVERRIDES  # type: ignore
    except Exception:
        LOCALE_OVERRIDES = {}
