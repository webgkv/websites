...
from icefish_demo_full_locales import get_all_full_locales
from icefish_demo_full_ru import get_russian
from icefish_demo_html_extract import extract_english
...
IMAGES = {
    ...
    "interface": "/assets/images/ice-fish-download-interface.webp",
...
LOCALE_META = {
    1: {
        "code": "en",
        "name": "Demo",
        "title": "Ice Fish Demo Free Play | Test the Game Online",
        "description": "Play Ice Fish demo free with virtual balance. Learn when to cash out, try difficulty levels, and see how demo mode differs from real-money play.",
    },
    3: {
        "code": "fr",
        "name": "Démo",
        "title": "Démo Ice Fish gratuite | Jouer en ligne sans risque",
        "description": "Jouez à la démo Ice Fish gratuitement avec un solde virtuel. Apprenez à encaisser, testez les niveaux de difficulté et comparez démo et argent réel.",
    },
    4: {
        "code": "de",
        "name": "Demo",
        "title": "Ice Fish Demo gratis | Spiel online testen",
        "description": "Spielen Sie die Ice Fish Demo kostenlos mit virtuellem Guthaben. Üben Sie Cash-out, testen Sie Schwierigkeitsgrade und vergleichen Sie Demo und Echtgeld.",
    },
    6: {
        "code": "es",
        "name": "Demo",
        "title": "Demo Ice Fish gratis | Prueba el juego online",
        "description": "Juega a la demo de Ice Fish gratis con saldo virtual. Aprende cuándo cobrar, prueba dificultades y compara la demo con el juego con dinero real.",
    },
    7: {
        "code": "hi",
        "name": "डेमो",
        "title": "Ice Fish डेमो मुफ्त | ऑनलाइन गेम आज़माएं",
        "description": "वर्चुअल बैलेंस के साथ Ice Fish डेमो मुफ्त खेलें। कैश-आउट का समय, कठिनाई स्तर और डेमो व असली खेल का अंतर समझें।",
    },
    8: {
        "code": "pt",
        "name": "Demo",
        "title": "Demo Ice Fish grátis | Teste o jogo online",
        "description": "Jogue a demo Ice Fish grátis com saldo virtual. Aprenda quando sacar, teste dificuldades e veja a diferença para o jogo com dinheiro real.",
    },
    9: {
        "code": "ru",
        "name": "Демо",
        "title": "Демо Ice Fish бесплатно | Играйте онлайн без риска",
        "description": "Играйте в демо Ice Fish бесплатно на виртуальный баланс. Разберитесь с выводом выигрыша, уровнями сложности и отличиями от игры на деньги.",
    },
    11: {
        "code": "ar",
        "name": "تجريبي",
        "title": "تجريبي Ice Fish مجاناً | جرّب اللعبة أونلاين",
        "description": "العب نسخة Ice Fish التجريبية مجاناً برصيد افتراضي. تعلّم توقيت السحب، جرّب مستويات الصعوبة وقارن بين التجريبي واللعب بمال حقيقي.",
    },
    12: {
        "code": "az",
        "name": "Demo",
        "title": "Ice Fish demo pulsuz | Oyunu onlayn sınayın",
        "description": "Virtual balansla Ice Fish demosunu pulsuz oynayın. Cash-out vaxtını öyrənin, çətinlik səviyyələrini sınayın və real pul oyunu ilə fərqi görün.",
    },
    13: {
        "code": "bn",
        "name": "ডেমো",
        "title": "Ice Fish ডেমো বিনামূল্যে | অনলাইনে গেম চেষ্টা করুন",
        "description": "ভার্চুয়াল ব্যালেন্সে Ice Fish ডেমো বিনামূল্যে খেলুন। ক্যাশ-আউটের সময়, কঠিনতার স্তর এবং ডেমো ও আসল খেলার পার্থক্য বুঝুন।",
    },
    14: {
        "code": "it",
        "name": "Demo",
        "title": "Demo Ice Fish gratis | Prova il gioco online",
        "description": "Gioca alla demo Ice Fish gratis con saldo virtuale. Impara quando incassare, prova le difficoltà e confronta demo e gioco con soldi veri.",
    },
    15: {
        "code": "nl",
        "name": "Demo",
        "title": "Ice Fish demo gratis | Test het spel online",
        "description": "Speel Ice Fish demo gratis met virtueel saldo. Leer wanneer je uitcasht, test moeilijkheidsgraden en zie het verschil met echt geld spelen.",
    },
    16: {
        "code": "pl",
        "name": "Demo",
        "title": "Demo Ice Fish za darmo | Testuj grę online",
        "description": "Graj w demo Ice Fish za darmo na wirtualnym saldzie. Naucz się wypłacać wygrane, testuj poziomy trudności i porównaj demo z grą na prawdziwe pieniądze.",
    },
    17: {
        "code": "vi",
        "name": "Demo",
        "title": "Demo Ice Fish miễn phí | Thử game trực tuyến",
        "description": "Chơi demo Ice Fish miễn phí với số dư ảo. Học thời điểm rút tiền, thử độ khó và so sánh demo với chơi bằng tiền thật.",
    },
    18: {
        "code": "ua",
        "name": "Демо",
        "title": "Демо Ice Fish безкоштовно | Грайте онлайн без ризику",
        "description": "Грайте в демо Ice Fish безкоштовно на віртуальний баланс. Зрозумійте виведення виграшу, рівні складності та відмінності від гри на гроші.",
    },
    19: {
        "code": "ro",
        "name": "Demo",
        "title": "Demo Ice Fish gratuit | Testează jocul online",
        "description": "Joacă demo Ice Fish gratuit cu sold virtual. Învață când să încasezi, testează dificultățile și compară demo cu jocul pe bani reali.",
    },
}
...
def english_alts() -> dict:
    return {
        "gameplay": "Ice Fish demo gameplay with multiplier on screen",
        "app": "Ice Fish demo on phone and desktop",
        "mobile": "Ice Fish mobile interface in portrait mode",
        "interface": "Ice Fish interface across devices",
        "step1": "Step 1: open Ice Fish demo",
        "step2": "Step 2: choose difficulty and bet",
        "step3": "Step 3: cash out in Ice Fish demo",
    }
