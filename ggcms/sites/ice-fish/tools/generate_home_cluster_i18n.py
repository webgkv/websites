...
def _subs(lang: str, text: str) -> str:
    links = {
        ...
        "__GAMES__": ('/en/games/', "Ice Fish games"),
        "__CR__": ('/en/games/ice-fish/', "Ice Fish"),
        "__CR2__": ('/en/games/ice-fish2/', "Ice Fish 2.0"),
        "__CR_ORIG__": ('/en/games/ice-fish/', "the original Ice Fish game"),
        "__CR2_REV__": ('/en/games/ice-fish2/', "Ice Fish 2.0 review"),
        "__CASINOS__": ('/en/casinos/', "Ice Fish casino"),
        "__CASINOS_OPTS__": ('/en/casinos/', "Ice Fish casino options"),
        "__DEMO__": ('/demo/', "Ice Fish demo"),
        "__DEMO_GUIDE__": ('/demo/', "Ice Fish demo guide"),
        "__DEMO_MODE__": ('/demo/', "demo mode"),
        "__DEMO_USUALLY__": ('/demo/', "usually available"),
        "__DOWNLOAD__": ('/en/download/', "Ice Fish download"),
        "__DL_GUIDE__": ('/en/download/', "download guide"),
        "__DL_FULL__": ('/en/download/', "Ice Fish download guide"),
        "__STRATEGIES__": ('/en/guides/how-to-win/ice-fish-strategy-guide/', "Ice Fish strategies"),
        "__CASHOUT__": ('/en/guides/signals/ice-fish-cash-out-guide/', "when to cash out"),
        "__STRATEGY__": ('/en/guides/how-to-win/ice-fish-strategy-guide/', "strategy guide"),
    }
...
def build_sections(lang: str, t: dict) -> dict[str, str]:
    ...
    sections["ice-fish-app"] = (
        ...
        + "".join(p(x) + "\r\n" for x in a["p"])
        + f'<figure {FIG}><img {IMG} src="/assets/images/ice-fish-app-desktop-mobile.webp" border="0" alt="{a["img_alt"]}" data-admin-img-edit="aie-1781875791288" /></figure>\r\n'
        + "".join(p(x) + "\r\n" for x in a["p2"])
        + '</div>\r\n</div>\r\n</div>\r\n</div>\r\n</section>'
    )
    ...
    sections["game-works"] = (
        ...
        '<div class="about_content">\r\n'
        + "".join(p(x) + "\r\n" for x in w["p"][:5])
        + f'<figure {FIG}><img {IMG} src="/assets/images/ice-fish-gameplay.webp" border="0" alt="{w["img_alt"]}" /></figure>\r\n'
        + "".join(p(x) + "\r\n" for x in w["p"][5:])
        + '</div>\r\n</div>\r\n</div>\r\n</div>\r\n</section>'
    )
    ...
    sections["demo-steps"] = (
        ...
        f'<img {STEP_IMG} src="/assets/images/ice-fish-step-1.webp" border="0" alt="{s["alt1"]}" width="640" height="354" />\r\n'
        ...
        '<div class="col-xl-4 col-lg-4 col-md-6">\r\n'
        '<div style="overflow: hidden; border-radius: 10px;" class="steps_box">'
        f'<img {STEP_IMG} src="/assets/images/ice-fish-step-2.webp" border="0" alt="{s["alt2"]}" width="640" height="360" />\r\n'
        '<div class="steps_content">\r\n'
        f'<h3>{s["s2h"]}</h3>\r\n'
        f'<p {P}>{s["s2p"]}</p>\r\n'
        '</div></div></div>\r\n'
        '<div class="col-xl-4 col-lg-4 col-md-6">\r\n'
        '<div style="overflow: hidden; border-radius: 10px;" class="steps_box">'
        f'<img {STEP_IMG} src="/assets/images/ice-fish-step-3.webp" border="0" alt="{s["alt3"]}" width="640" height="360" />\r\n'
        '<div class="steps_content">\r\n'
        f'<h3>{s["s3h"]}</h3>\r\n'
        f'<p {P}>{s["s3p"]}</p>\r\n'
        '</div></div></div>\r\n'
    ...
    sections["batting"] = (
        ...
        f'<figure {FIG}><img {IMG} src="/assets/images/ice-fish-mobile.webp" border="0" alt="{b["img_alt"]}" /></figure>\r\n'
        '</div></div>\r\n'
        '<div class="col-xl-6 col-lg-6 col-md-6">\r\n'
        '<div class="about_content">\r\n'
        + "".join(p(x) + "\r\n" for x in b["p"])
