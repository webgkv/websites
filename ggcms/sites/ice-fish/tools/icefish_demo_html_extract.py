...
def extract_english(html: str | None = None) -> dict:
    ...
    what_h2 = "What Is Ice Fish Demo Mode?"
    what_paras = _section_paras(sections[1][1])

    start_h2 = "How to Start Ice Fish Demo"
    start_steps = [
        _clean(block)
        for block in re.findall(
    ...
    mobile_h2 = "Ice Fish Demo on Mobile"
    mobile_paras = _section_paras(sections[5][1])

    download_h2 = "Can You Download Ice Fish Demo?"
    download_paras = _section_paras(sections[6][1])

    trouble_h2 = "If Ice Fish Demo Does Not Start"
    ...
    return {
        "intro_h2": "Ice Fish Demo — play free without risk",
