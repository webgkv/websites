#!/usr/bin/env python3
"""
Prepare Aviator Sypex Dumper (SXD20) dump for Ice Fish.
...
Usage:
  python3 scripts/prepare_icefish_db.py \\
    tmp/db/dikodo_aviator_2026-05-18_14-51-15.sql.gz \\
    tmp/db/icefish_prepared.sql.gz
"""
...
REBRAND = (
    (re.compile(r"Aviator Log In", re.I), "Ice Fish"),
    (re.compile(r"Aviator Log-in", re.I), "Ice Fish"),
    (re.compile(r"\bAviator\b"), "Ice Fish"),
    (re.compile(r"\baviator\b"), "ice-fish"),
    (re.compile(r"dikodo_aviator", re.I), "dikodo_icefish"),
    (re.compile(r"ice-fish-hero\.png", re.I), "ice-fish-hero.webp"),
    (re.compile(r"aviator-app-and-mobile-version\.png", re.I), "ice-fish-hero.webp"),
    (re.compile(r"aviator-app-and-mobile-version\.webp", re.I), "ice-fish-hero.webp"),
)
