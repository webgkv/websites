# -*- coding: utf-8 -*-
"""One-off assembler for chickenroad_demo_full_locales.py"""
...
OUT = TOOLS / "chickenroad_demo_full_locales.py"
...
def _az() -> dict:
    return {
        "intro_h2": "Chicken Road Demo — risksiz pulsuz oynayın",
        "intro_paras": [
            "Chicken Road populyar oldu, çünki başlanğıcda oyunçudan çox düşünməyə məcbur etmir. Oyunu açırsınız və ideyanı demək olar ki, dərhal başa düşürsünüz. Klassik slot xaosu, fırlanan barabanlar və ya çaşdırıcı simvollar yoxdur. Kiçik arkadaya bənzəyir, amma hər növbəti addım yenə də risk daşıyır.",
            "Məhz buna görə Chicken Road bu qədər yaxşı işləyir. Klassik kazino oyunundan çox arkadaya oxşayır. Toyuğu, yolu, maşınları görürsünüz və əsas qərar həmişə aydındır: cari nəticəni götürmək və ya bir addım daha cəhd etmək.",
            ...
            "Saytımızdakı pulsuz versiya məhz bunun üçündür — Chicken Road-u özünüz sınamaq üçün. Demonu açın, virtual balansla oynayın, mexanikanı yoxlayın və bir sent xərcləmədən oyundan həzz alın.",
            "Real pul oyununa keçməzdən əvvəl bu oyunun niyə bu qədər populyar olduğunu anlamaq üçün yaxşı yoldur.",
        ],
        "what_h2": "Chicken Road demo rejimi nədir?",
        "what_paras": [
            "Chicken Road Demo oyunun pulsuz versiyasıdır. Real pul deyil, virtual balansla oynayırsınız. Əsas məqam budur. Oyunu aça, test mərci qoya, çətinlik səviyyəsi seçə və toyuğun yol boyu necə irəlilədiyini öz vəsaitinizi itirmək qorxusu olmadan görə bilərsiniz. Səhv addım etsəniz, ciddi heç nə olmur — yalnız demo kreditlər itir və yenidən başlayırsınız.",
            "Demo başqa oyun deyil. Real versiyaya demək olar ki, eyni işləyir. Toyuq addım-addım irəliləyir, hər təhlükəsiz addımdan sonra multiplikator artır və nə vaxt dayanacağınıza qərar verməlisiniz. İndi qazanını götürmək və ya bir addım daha — Chicken Road-un bütün gərginliyi budur.",
            ...
            "Real pul hər şeyi dəyişir. Eyni addım öz balansınız olanda fərqli hiss olunur. Chicken Road Demo-nu məhz onun güclü olduğu üçün istifadə edin — oyunu öyrənmək, düymələri sınamaq və real mərc haqqında düşünməzdən əvvəl riski başa düşmək.",
        ],
        "start_h2": "Chicken Road Demo-ya necə başlamaq olar",
        "start_steps": [
            "Chicken Road demosuna başlamaq çox sadədir. İstəsəniz tətbiqi yükləyib quraşdırın və quraşdırma bitəndə açın. Həmçinin saytımızın səhifəsində brauzerdə birbaşa oynaya bilərsiniz.",
        ...
        "why_before": [
            "Demo real pul istifadə etməzdən əvvəl Chicken Road-u başa düşməyin ən təhlükəsiz yoludur. Orada səhv edə bilərsiniz — məhz bunun üçündür.",
        ...
        "mobile_h2": "Mobil cihazda Chicken Road Demo",
        "mobile_paras": [
            "Chicken Road demo telefonda problemsiz işləyir. Oyun sadədir, böyük ekran lazım deyil. Açırsınız, toyuğu, yolu, mərc məbləğini və əsas düymələri görürsünüz — kifayətdir.",
            ...
            "Demonu birbaşa brauzerdən oynaya bilərsiniz. Tətbiq məcburi deyil, amma daha sürətli giriş üçün saytımızdakı App qısayolundan istifadə edin. Chicken Road Demo ikonunu əsas ekrana qoyur, növbəti dəfə səhifə axtarmalı olmursunuz.",
        ],
        "download_h2": "Chicken Road Demo yükləmək olarmı?",
        "download_paras": [
            "Oynamaq üçün Chicken Road Demo-nu yükləmək lazım deyil. Demo veb üzərindən işləyir — brauzerdən açıb virtual balansla dərhal oynaya bilərsiniz.",
            "Saytımızda tətbiq tipli qısayol və ya PWA ilə sürətli giriş də ola bilər. Telefonda tətbiq kimi görünür, amma demo yenə sayt üzərindən işləyir. Məqsəd rahatlıqdır: ikona toxunub Chicken Road-u daha tez açmaq.",
            "Digər saytlardan təsadüfi APK fayllarına diqqətli olun. «Xüsusi Chicken Road APK», «hack versiya» və ya «predictor app» təklif edən səhifələri keçin. Bu fayllar saxta ola bilər və bəzən yalnız məlumat toplamaq üçündür.",
            "Adi demo oyunu üçün brauzer versiyası kifayətdir. Səhifəni açın, oyunu işə salın və riskli quraşdırma olmadan Chicken Road-u sınayın.",
        ],
        "trouble_h2": "Chicken Road Demo işə düşmirsə",
        "trouble_paras": [
        ...
        "safety_paras": [
            "Chicken Road Demo bir məqsəd üçün yaradılıb — real pul istifadə etməzdən əvvəl oyunu sınamaq. Açırsınız, virtual balansla oynayırsınız, düymələri yoxlayırsınız və raundun necə işlədiyini görürsünüz. Demo yalnız bunu etməlidir.",
            ...
            "Chicken Road adını istifadə edib «zəmanətli qazanclar», «gizli proqnoz» və ya «real ödənişli xüsusi demo» vəd edən səhifələrə diqqətli olun. Adi demo belə işləmir — virtual kredit istifadə edir və nəticə demoda qalır.",
            "Sadə qayda: əgər həqiqətən pulsuz demosudursa, pul istəməməlidir.",
        ],
        "faq_h2": "FAQ — Chicken Road Demo",
        "faq": [
            ("Chicken Road Demo-nu pulsuz oynaya bilərəmmi?", "Bəli. Saytımızdakı demo pulsuzdur və real pul risk etmirsiniz."),
            ...
            ("Chicken Road Demo mobil işləyirmi?", "Tətbiq xüsusilə mobil versiya nəzərə alınaraq hazırlanıb."),
            ...
            ("Növbəti addım proqnozlaşdırıla bilərmi?", "Xeyr. Növbəti hərəkətdə nə olacağını əvvəlcədən bilmək olmaz. «Chicken Road proqnozları» vəd edən app və ya saytlara ehtiyatla yanaşın."),
            ...
            ("Bu rəsmi Chicken Road oyunudur?", "Chicken Road InOut Games tərəfindən hazırlanıb. Saytımızdakı demo məşq üçündür. Saytımız InOut Games-in rəsmi saytı deyil."),
        ],
        "titles": {
        ...
        "alts": {
            "gameplay": "Ekranda multiplikatorla Chicken Road demo gameplay",
            "app": "App və ya brauzer vasitəsilə Chicken Road demo girişi",
            "mobile": "Portret rejimində mobil Chicken Road Demo",
            "interface": "Müxtəlif cihazlarda Chicken Road demo interfeysi",
            "step1": "Addım 1 — Chicken Road demosunu açın və çətinlik seçin",
            "step2": "Addım 2 — Chicken Road Demo-da virtual mərc təyin edin",
            "step3": "Addım 3 — təhlükəsiz addımdan sonra Chicken Road Demo-da Cash Out",
        },
    }
...
def _vi() -> dict:
    return {
        "intro_h2": "Chicken Road Demo — chơi miễn phí không rủi ro",
        "intro_paras": [
            "Chicken Road trở nên phổ biến vì lúc bắt đầu bạn không phải suy nghĩ quá nhiều. Mở game là hiểu ý tưởng gần như ngay lập tức. Không có hỗn loạn slot cổ điển, không guồng quay, không biểu tượng rối. Trông giống arcade nhỏ, nhưng mỗi bước tiếp theo vẫn mang rủi ro.",
            "Đó chính là lý do Chicken Road hoạt động tốt. Cảm giác giống game arcade hơn là tựa casino cổ điển. Bạn thấy gà, đường, xe — và quyết định chính luôn rõ: giữ kết quả hiện tại hay thử thêm một bước.",
            ...
            "Phiên bản miễn phí trên site của chúng tôi dành đúng cho việc đó — để bạn tự thử Chicken Road. Mở demo, chơi bằng số dư ảo, thử cơ chế và tận hưởng mà không tốn một xu.",
            "Đó là cách hay để hiểu vì sao game này nổi tiếng trước khi nghĩ đến chơi tiền thật.",
        ],
        "what_h2": "Chế độ demo Chicken Road là gì?",
        "what_paras": [
            "Chicken Road Demo là phiên bản miễn phí của game. Bạn chơi bằng số dư ảo, không phải tiền thật. Đó là điểm chính. Bạn có thể mở game, đặt cược thử, chọn độ khó và xem gà đi trên đường mà không lo mất tiền của mình. Sai một nước cũng không sao — chỉ mất credit demo và bắt đầu lại.",
            "Demo không phải game khác. Hoạt động gần như bản thật. Gà vẫn đi từng bước, hệ số nhân tăng sau mỗi bước an toàn, và bạn vẫn phải quyết định khi nào dừng. Rút tiền ngay hay thử thêm một bước — đó là toàn bộ áp lực của Chicken Road.",
            ...
            "Tiền thật thay đổi mọi thứ. Cùng một bước cảm giác khác khi số dư của bạn đang stake. Dùng Chicken Road Demo đúng việc nó giỏi — học game, thử nút và hiểu rủi ro trước khi nghĩ cược thật.",
        ],
        "start_h2": "Cách bắt đầu Chicken Road Demo",
        "start_steps": [
            "Bắt đầu demo Chicken Road khá đơn giản. Tải và cài app nếu muốn, mở sau khi cài xong. Hoặc chơi trực tiếp trên trình duyệt ở trang site của chúng tôi.",
        ...
        "why_before": [
            "Demo là cách an toàn nhất để hiểu Chicken Road trước khi dùng tiền thật. Bạn có thể sai ở đó — đó là mục đích.",
        ...
        "mobile_h2": "Chicken Road Demo trên di động",
        "mobile_paras": [
            "Demo Chicken Road chạy tốt trên điện thoại. Game đơn giản, không cần màn hình lớn. Mở là thấy gà, đường, số cược và nút chính — đủ rồi.",
            ...
            "Bạn có thể chơi demo thẳng từ trình duyệt. Không bắt buộc app, nhưng muốn truy cập nhanh hơn dùng shortcut App trên site. Nó đặt icon Chicken Road Demo lên màn hình chính, lần sau không phải tìm trang.",
        ],
        "download_h2": "Có thể tải Chicken Road Demo không?",
        "download_paras": [
            "Bạn không thực sự cần tải Chicken Road Demo để chơi. Demo chạy qua web — mở từ trình duyệt và chơi ngay bằng số dư ảo.",
            "Trên site chúng tôi có thể có shortcut kiểu app hoặc PWA. Trên điện thoại trông và cảm giác như app, nhưng demo vẫn chạy qua website. Điểm chính là tiện: chạm icon và mở Chicken Road nhanh hơn.",
            "Cẩn thận file APK ngẫu nhiên từ site khác. Trang nào offer «APK Chicken Road đặc biệt», «bản hack» hay «app dự đoán» thì nên bỏ qua. File có thể giả, đôi khi chỉ để thu thập dữ liệu.",
            "Với chơi demo bình thường, bản trình duyệt là đủ. Mở trang, khởi chạy game và thử Chicken Road mà không cài gì rủi ro.",
        ],
        "trouble_h2": "Nếu Chicken Road Demo không khởi động",
        "trouble_paras": [
        ...
        "safety_paras": [
            "Chicken Road Demo được tạo cho một việc — để bạn thử game trước khi dùng tiền thật. Mở, chơi số dư ảo, thử nút và xem vòng hoạt động. Demo chỉ nên làm vậy.",
            ...
            "Cẩn thận trang dùng tên Chicken Road nhưng hứa «thắng chắc», «dự đoán bí mật» hay «demo đặc biệt trả tiền thật». Demo bình thường không hoạt động vậy — dùng credit ảo và mọi kết quả ở trong demo.",
            "Quy tắc đơn giản: nếu thật sự là demo miễn phí thì không nên xin tiền.",
        ],
        "faq_h2": "FAQ — Chicken Road Demo",
        "faq": [
            ("Tôi có thể chơi Chicken Road Demo miễn phí không?", "Có. Demo trên site chúng tôi miễn phí và bạn không mạo hiểm tiền thật."),
            ...
            ("Chicken Road Demo có chạy trên mobile không?", "App được thiết kế đặc biệt với phiên bản mobile."),
            ("Tôi có phải tải gì không?", "Không. Demo chơi trên trình duyệt. Muốn nhanh hơn dùng shortcut trên site, nhưng không bắt buộc."),
            ("Có thể dự đoán bước tiếp theo không?", "Không. Bạn không biết trước điều gì xảy ra ở nước tiếp. App hoặc site hứa «dự đoán Chicken Road» nên cẩn thận."),
            ...
            ("Đây có phải game Chicken Road chính thức không?", "Chicken Road do InOut Games phát triển. Demo trên site chúng tôi để luyện tập. Site chúng tôi không phải site chính thức của InOut Games."),
        ],
        "titles": {
        ...
        "alts": {
            ...
            "app": "Truy cập demo Chicken Road qua app hoặc trình duyệt",
            "mobile": "Chicken Road Demo trên mobile ở chế độ dọc",
            "interface": "Giao diện demo Chicken Road trên nhiều thiết bị",
            "step1": "Bước 1 — mở demo Chicken Road và chọn độ khó",
            "step2": "Bước 2 — đặt cược ảo trong Chicken Road Demo",
            "step3": "Bước 3 — Cash Out trong Chicken Road Demo sau bước an toàn",
        },
    }
...
def _ro() -> dict:
    return {
        ...
        "intro_paras": [
            "Chicken Road a devenit popular pentru că la început nu te obligă să gândești prea mult. Îl deschizi și înțelegi ideea aproape imediat. Fără haos de slot clasic, fără role care se învârt, fără simboluri confuze. Arată ca un arcade mic, dar fiecare pas următor poartă totuși risc.",
            "De aceea Chicken Road funcționează atât de bine. Se simte mai degrabă ca un joc arcade decât ca un titlu clasic de casino. Vezi găina, drumul, mașinile, iar decizia principală rămâne clară: păstrezi rezultatul actual sau încerci încă un pas.",
            ...
            "Versiunea gratuită de pe site-ul nostru e făcută exact pentru asta — să încerci Chicken Road singur. Poți deschide demo-ul, juca cu sold virtual, testa mecanica și te bucura fără să cheltui un cent.",
        ...
        "what_paras": [
            ...
            "Demo-ul nu e alt joc. Funcționează aproape la fel ca versiunea reală. Găina merge pas cu pas, multiplicatorul crește după fiecare pas sigur și tot trebuie să decizi când te oprești. Cash out acum sau încă un pas — asta e toată tensiunea Chicken Road.",
            ...
            "Banii reali schimbă totul. Același pas se simte diferit când soldul tău e în joc. Folosește Chicken Road Demo pentru ce face bine — învață jocul, testează butoanele și înțelege riscul înainte să te gândești la pariuri reale.",
        ],
        "start_h2": "Cum pornești Chicken Road Demo",
        "start_steps": [
            "Pornirea demo-ului Chicken Road e destul de simplă. Descarcă și instalează aplicația dacă vrei și deschide-o după instalare. Poți juca și direct în browser pe pagina site-ului nostru.",
        ...
        "mobile_h2": "Chicken Road Demo pe mobil",
        "mobile_paras": [
            "Demo-ul Chicken Road merge bine pe telefon. Jocul e simplu, nu are nevoie de ecran uriaș. Îl deschizi, vezi găina, drumul, suma pariului și butoanele principale — e suficient.",
            ...
            "Poți juca demo-ul direct din browser. Aplicația nu e obligatorie, dar pentru acces mai rapid folosește scurtătura App de pe site. Pune iconița Chicken Road Demo pe ecranul principal, ca data viitoare să nu cauți pagina.",
        ],
        "download_h2": "Poți descărca Chicken Road Demo?",
        "download_paras": [
            "Nu ai nevoie cu adevărat să descarci Chicken Road Demo ca să joci. Demo-ul merge prin web — îl deschizi din browser și joci imediat cu sold virtual.",
            "Pe site-ul nostru putem oferi și acces rapid printr-o scurtătură tip app sau PWA. Pe telefon arată și se simte ca o aplicație, dar demo-ul tot rulează prin site. Ideea e confortul: atingi iconița și deschizi Chicken Road mai repede.",
            "Ai grijă la fișiere APK aleatoare de pe alte site-uri. Dacă o pagină oferă «APK special Chicken Road», «versiune hack» sau «app predictor», mai bine sari peste. Fișierele pot fi false și uneori sunt făcute doar să colecteze date.",
            "Pentru joc demo normal, versiunea din browser e suficientă. Deschide pagina, lansează jocul și testează Chicken Road fără instalări riscante.",
        ],
        "trouble_h2": "Dacă Chicken Road Demo nu pornește",
        "trouble_paras": [
        ...
        "safety_paras": [
            ...
            "Ai grijă la pagini care folosesc numele Chicken Road dar promit «câștiguri garantate», «predicție secretă» sau «demo special cu plăți reale». Un demo normal nu funcționează așa — folosește credite virtuale și orice rezultat rămâne în demo.",
            "Regulă simplă: dacă e cu adevărat demo gratuit, nu ar trebui să ceară bani.",
        ],
        "faq_h2": "FAQ — Chicken Road Demo",
        "faq": [
            ("Pot juca Chicken Road Demo gratuit?", "Da. Demo-ul de pe site-ul nostru e gratuit și nu riști bani reali."),
            ...
            ("Chicken Road Demo merge pe mobil?", "Aplicația a fost concepută special cu versiunea mobilă în minte."),
            ...
            ("Se poate prezice pasul următor?", "Nu. Nu poți ști dinainte ce se întâmplă la mutarea următoare. Orice app sau site care promite «predicții Chicken Road» merită tratat cu prudență."),
            ...
            ("Acesta e jocul oficial Chicken Road?", "Chicken Road e dezvoltat de InOut Games. Demo-ul de pe site-ul nostru e pentru practică. Site-ul nostru nu e site-ul oficial InOut Games."),
        ],
        "titles": {
        ...
        "alts": {
            ...
            "app": "Acces demo Chicken Road prin app sau browser",
            "mobile": "Chicken Road Demo pe mobil în mod portret",
            "interface": "Interfața demo Chicken Road pe mai multe dispozitive",
            "step1": "Pasul 1 — deschide demo Chicken Road și alege dificultatea",
            "step2": "Pasul 2 — definește pariul virtual în Chicken Road Demo",
            "step3": "Pasul 3 — Cash Out în Chicken Road Demo după un pas sigur",
        },
    }
...
def main() -> None:
    ...
    parts = [
        '# -*- coding: utf-8 -*-',
        '"""Full localized body copy for Chicken Road demo page (14 locales)."""',
        "",
        "from __future__ import annotations",
        "",
        "",
