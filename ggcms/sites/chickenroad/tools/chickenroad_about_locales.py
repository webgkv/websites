#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""About Us (pages#26) — Chicken Road content for all locales."""
...
LOCALE_CONTENT: dict[str, str] = {
    "en": _wrap("""
<h1>About Chicken Road</h1>
<p><strong>Chicken Road</strong> is an independent informational resource about the <em>Chicken Road</em> step game (InOut Games), licensed casinos that host the game, and related topics&mdash;demo play, guides, bonuses, and safer gambling.</p>
...
"""),
    "fr": _wrap("""
<h1>&Agrave; propos de Chicken Road</h1>
<p><strong>Chicken Road</strong> est un site d&rsquo;information ind&eacute;pendant sur le jeu par &eacute;tapes <em>Chicken Road</em> (InOut Games), les casinos en ligne qui le proposent, ainsi que la d&eacute;mo, les guides, les bonus et le jeu responsable.</p>
...
"""),
    "de": _wrap("""
<h1>&Uuml;ber Chicken Road</h1>
<p><strong>Chicken Road</strong> ist ein unabh&auml;ngiger Informationsdienst &uuml;ber das Schrittspiel <em>Chicken Road</em> (InOut Games), lizenzierte Casinos, die es anbieten, sowie Demo-Spiel, Anleitungen, Boni und sicheres Gl&uuml;cksspiel.</p>
...
"""),
    "es": _wrap("""
<h1>Acerca de Chicken Road</h1>
<p><strong>Chicken Road</strong> es un recurso informativo independiente sobre el juego por pasos <em>Chicken Road</em> (InOut Games), casinos con licencia que lo ofrecen y temas relacionados: demo, gu&iacute;as, bonos y juego responsable.</p>
...
"""),
    "hi": _wrap("""
<h1>Chicken Road के बारे में</h1>
<p><strong>Chicken Road</strong> <em>Chicken Road</em> स्टेप गेम (InOut Games), इसे होस्ट करने वाले लाइसेंस प्राप्त कैसिनो और संबंधित विषयों—डेमो, गाइड, बोनस और सुरक्षित खेल—के बारे में एक स्वतंत्र जानकारी संसाधन है।</p>
...
"""),
    "pt": _wrap("""
<h1>Sobre o Chicken Road</h1>
<p><strong>Chicken Road</strong> &eacute; um recurso informativo independente sobre o jogo por passos <em>Chicken Road</em> (InOut Games), cassinos licenciados que o oferecem e temas relacionados &mdash; demo, guias, b&oacute;nus e jogo respons&aacute;vel.</p>
...
"""),
    "ru": _wrap("""
<h1>О Chicken Road</h1>
<p><strong>Chicken Road</strong> &mdash; независимый информационный ресурс о пошаговой игре <em>Chicken Road</em> (InOut Games), лицензированных казино, где она доступна, а также о демо, гайдах, бонусах и ответственной игре.</p>
...
"""),
    "ar": _wrap("""
<h1>حول Chicken Road</h1>
<p><strong>Chicken Road</strong> مورد معلومات مستقل عن لعبة الخطوات <em>Chicken Road</em> (InOut Games)، والكازينوهات المرخّصة التي تستضيفها، وموضوعات ذات صلة &mdash; العرض التجريبي، الأدلة، المكافآت واللعب المسؤول.</p>
...
"""),
    "az": _wrap("""
<h1>Chicken Road haqqında</h1>
<p><strong>Chicken Road</strong> <em>Chicken Road</em> addım oyunu (InOut Games), onu təqdim edən lisenziyalı kazinolar və əlaqəli mövzular &mdash; demo, bələdçilər, bonuslar və məsuliyyətli oyun haqqında müstəqil informasiya mənbəyidir.</p>
...
"""),
    "bn": _wrap("""
<h1>Chicken Road সম্পর্কে</h1>
<p><strong>Chicken Road</strong> <em>Chicken Road</em> স্টেপ গেম (InOut Games), এটি হোস্ট করা লাইসেন্সপ্রাপ্ত ক্যাসিনো এবং সম্পর্কিত বিষয় &mdash; ডেমো, গাইড, বোনাস ও দায়িত্বশীল খেলা &mdash; নিয়ে একটি স্বাধীন তথ্য উৎস।</p>
...
"""),
    "it": _wrap("""
<h1>Informazioni su Chicken Road</h1>
<p><strong>Chicken Road</strong> &egrave; una risorsa informativa indipendente sul gioco a passi <em>Chicken Road</em> (InOut Games), i casin&ograve; con licenza che lo ospitano e argomenti correlati &mdash; demo, guide, bonus e gioco responsabile.</p>
...
"""),
    "nl": _wrap("""
<h1>Over Chicken Road</h1>
<p><strong>Chicken Road</strong> is een onafhankelijke informatiebron over het stapspel <em>Chicken Road</em> (InOut Games), gelicentieerde casino&rsquo;s die het aanbieden en gerelateerde onderwerpen &mdash; demo, gidsen, bonussen en verantwoord spelen.</p>
...
"""),
    "pl": _wrap("""
<h1>O Chicken Road</h1>
<p><strong>Chicken Road</strong> to niezale&#380;ne &#378;r&oacute;d&#322;o informacji o grze krokowej <em>Chicken Road</em> (InOut Games), licencjonowanych kasynach, kt&oacute;re j&#261; oferuj&#261;, oraz powi&#261;zanych tematach &mdash; demo, przewodnikach, bonusach i bezpiecznym graniu.</p>
...
"""),
    "ua": _wrap("""
<h1>Про Chicken Road</h1>
<p><strong>Chicken Road</strong> &mdash; незалежний інформаційний ресурс про покрокову гру <em>Chicken Road</em> (InOut Games), ліцензовані казино, де вона доступна, а також демо, гайди, бонуси та відповідальну гру.</p>
...
"""),
    "ro": _wrap("""
<h1>Despre Chicken Road</h1>
<p><strong>Chicken Road</strong> este o resurs&#259; independent&#259; de informa&#539;ii despre jocul pe pa&#537;i <em>Chicken Road</em> (InOut Games), cazinouri licen&#539;iate care &icirc;l g&#259;zduiesc &#537;i subiecte conexe &mdash; demo, ghiduri, bonusuri &#537;i joc responsabil.</p>
