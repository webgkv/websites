#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Rebuild casino_articles#26 BC.Game Chicken Road cluster — clean HTML + locale translations."""
...
from chickenroad_casino_articles_26_locales import IMAGES, LOCALE_META, get_body  # noqa: E402
...
def main() -> None:
    ...
    for lang_id, meta in LOCALE_META.items():
        ...
        loc = {
            ...
            "url": meta.get("url", "bc-game-chicken-road"),
            "name": meta["name"],
            "title": meta["title"],
