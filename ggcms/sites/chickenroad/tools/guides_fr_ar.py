#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Load guides fr/ar meta and translation pairs from JSON data files."""
...
DATA_DIR = Path(__file__).resolve().parent / "guides_fr_ar_data"


def _load(entity_id: int) -> dict | None:
    path = DATA_DIR / f"guides_{entity_id}.json"
    if not path.is_file():
        return None
