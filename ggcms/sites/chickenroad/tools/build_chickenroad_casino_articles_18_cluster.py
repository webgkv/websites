#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Rebuild casino_articles#18 MOSTBET Chicken Road cluster."""
...
from chickenroad_casino_articles_18_locales import IMAGES, LOCALE_META, get_body  # noqa: E402
...
def main() -> None:
    ...
    for lang_id, meta in LOCALE_META.items():
        ...
        loc = {
            ...
            "url": meta.get("url", "mostbet-chicken-road"),
            "name": meta["name"],
            "title": meta["title"],
