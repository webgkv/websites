#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Append UA + translated locales to chickenroad_home_strings.py"""
...
STRINGS_PY = ROOT / "tools/chickenroad_home_strings.py"
I18N_JSON = ROOT / "tools/chickenroad_home_i18n.json"
