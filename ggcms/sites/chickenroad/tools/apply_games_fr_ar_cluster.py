#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Apply French (3) and Arabic (11) to a games cluster JSON export from EN template."""
...
def main() -> int:
    if len(sys.argv) < 2:
        print("Usage: apply_games_fr_ar_cluster.py <cluster.json> [out.json]", file=sys.stderr)
        return 1
    src = Path(sys.argv[1])
