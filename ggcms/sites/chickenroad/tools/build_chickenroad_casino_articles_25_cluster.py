#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Rebuild casino_articles#25 Jack-Pot Chicken Road cluster — clean HTML + locale translations."""
...
from chickenroad_casino_articles_25_locales import IMAGES, LOCALE_META, get_body  # noqa: E402

CLUSTER_IN = Path("/Users/gk/Downloads/05/seo-casino_articles-25-full.json")
OUT_PATH = CLUSTER_IN
...
def build_content(body: dict) -> str:
    ...
    chunks.append(paras(body["play_paras"]))
...
def main() -> None:
    ...
    for lang_id, meta in LOCALE_META.items():
        ...
        loc = {
            ...
            "url": meta.get("url", "jack-pot-chicken-road"),
            "name": meta["name"],
            "title": meta["title"],
            ...
            "seo_monitor_ctx": {"entity": "casino_articles", "entity_id": 25},
        }
        new_locales.append(loc)

    cluster["entity"] = "casino_articles"
    cluster["entity_id"] = 25
