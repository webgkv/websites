...
_TRANS = {
    "sw": [
        ...
        [
            "The difficulty settings add another layer. Easy, Medium, Hard, Hardcore &mdash; each mode changes the feeling of the game. Easy feels calmer. Hardcore looks tempting because the multipliers are much bigger, but the risk grows fast. For experienced players, this creates a stronger sense of strategy, even though the result is still based on chance.",
        ...
        [
            "But the feeling of control can be tricky. You control when to move and when to stop, but not where the danger is &mdash; the result is still based on chance. The smartest way to look at Chicken Road: the game rewards discipline more than courage. Cashing out early may feel boring, but waiting too long is usually where players lose their bet.",
        ...
        [
            "Chicken Road can be entertaining, especially because the rounds are short and the game does not look serious. But it is still gambling. Real money changes the feeling completely. A step that feels funny in demo mode can feel very different when your own balance is involved.",
        ...
        [
            "That is the part many players forget. The fact that the game gives you time to think before the next move is intentional. It feels like control. And yes, you do control the moment when you cash out. But you do not control what happens on the next step.",
        ...
        [
            "It has a cartoon look, but the mechanic is not childish at all. The game keeps pushing the same question at the player: cash out now, or survive one more step? That \"one more step\" feeling is the main hook. Sometimes too involved.",
        ...
        [
            "A stable internet connection is required for a smooth run without delays. But Chicken Road has one advantage here: the game doesn't keep players under constant time pressure, so it remains playable even with some lag.",
        ...
        [
            "That feeling can be dangerous. The player controls the button, not the outcome. You can choose when to stop, but you cannot know if the next lane is safe. This is why Chicken Road became so popular.",
    ...
    "ln": [
        ...
        [
            "By the beginning of 2026, Chicken Road is still one of the most talked-about fast casino games online. Part of that comes from the design: it doesn't look heavy or aggressive, more like a simple arcade game. But behind that friendly style sits a clear gambling structure &mdash; every next move gives a better multiplier, and every next move can also end the round.",
            "Na ebandeli ya 2026, Chicken Road ezali nokinoki moko ya ba jeux ya casino ya mbangu oyo bato balobelaka mingi na internet. Esangani na design: ezali te lourde to agressive, ezali lokola lisano ya arcade ya pétó. Kasi na sima ya style ya friendly ezali structure ya gambling ya polele &mdash; matambe elandi epesaka multiplicateur ya malamu, mpe matambe elandi ekoki mpe kosilisa round."
        ],
        [
            "Visually, the game feels light, almost like a small arcade game on your phone. The chicken animation is funny, the colours are simple, and nothing on screen feels too serious. But the mechanic behind it is pure gambling psychology: every safe step gives a better multiplier, and every next step makes it harder to stop. That's the part that gets players.",
            "Na visual, lisano ezali pétó, quasi lokola lisano ya arcade ya moke na telefone na yo. Animation ya nkoko ezali funny, ba couleurs ezali simple, mpe eloko moko te na écran ezali trop sérieux. Kasi mécanique na sima ezali psychologie ya gambling ya polele: matambe mosusu oyo ezali malamu epesaka multiplicateur ya malamu, mpe matambe elandi esalelaka ete ezala pétó kotelema. Yango ezali part oyo ezwaka ba joueurs."
        ],
        [
            "The difficulty settings add another layer. Easy, Medium, Hard, Hardcore &mdash; each mode changes the feeling of the game. Easy feels calmer. Hardcore looks tempting because the multipliers are much bigger, but the risk grows fast. For experienced players, this creates a stronger sense of strategy, even though the result is still based on chance.",
            "Ba réglages ya difficulté bazongisa couche mosusu. Easy, Medium, Hard, Hardcore &mdash; mode moko na moko ebongisaka feeling ya lisano. Easy ezali calme mingi. Hardcore ezali tempting mpo na multiplicateurs ezali monene mingi, kasi riski ekoloka na mbangu. Mpo na ba joueurs expérimentés, yango esalelaka sentiment ya stratégie ya makasi, ata soki résultat ezali nokinoki na hasard."
        ],
        [
            "But the feeling of control can be tricky. You control when to move and when to stop, but not where the danger is &mdash; the result is still based on chance. The smartest way to look at Chicken Road: the game rewards discipline more than courage. Cashing out early may feel boring, but waiting too long is usually where players lose their bet.",
            "Kasi feeling ya contrôle ekoki kozala tricky. Ozali na contrôle ntango okende mpe ntango oteleme, kasi te esika danger ezali &mdash; résultat ezali nokinoki na hasard. Ndenge ya malamu ya kolinga Chicken Road: lisano elembi discipline koleka courage. Cash Out liboso ekoki kozala boring, kasi kozela mingi ezali ndenge bato basala pari."
        ],
        [
            "The interface also includes a difficulty option: Easy, Medium, Hard, and Hardcore. These modes change the risk level and the multiplier ladder. On easier modes, multipliers grow slower but survival odds are better. On Hardcore, the numbers look much bigger, but the chicken is in danger almost from the start.",
            "Interface ezali na option ya difficulté: Easy, Medium, Hard, mpe Hardcore. Ba modes oyo ebongisaka riski mpe échelle ya multiplicateur. Na modes ya pétó, multiplicateurs ekoloka mpololo kasi chances ya survivre ezali malamu. Na Hardcore, ba chiffres ezali monene mingi, kasi nkoko ezali na danger quasi banda ebandeli."
        ],
        [
            "With virtual money, most players are calmer and take bigger risks just to see what happens. With real money, the same button feels different &mdash; greed starts creeping in, and that changes decisions fast. A good demo run doesn't mean you found a winning method; it only means you had a good demo round.",
            "Na mbongo virtuel, ba joueurs mingi bazali calme mpe bazali kozwa riski ya monene kaka mpo na komona oyo ekosala. Na mbongo ya solo, bouton moko ezali different &mdash; cupidité ebandi kokota, mpe yango ebongisaka ba décisions na mbangu. Course ya demo ya malamu elingi te ete ozui méthode ya gain; elingi kaka ete ozalaki na round ya demo ya malamu."
        ],
        [
            "That's where the pressure starts. Every next lane gives a better multiplier, but every next lane also brings more risk. If the chicken gets hit before you cash out, the bet is gone &mdash; no matter how many lanes you've already passed. Until you make Cash Out, the win is only potential.",
        ...
        [
            "Play only for entertainment. Not for income, not for \"recovering\" money, not because you think the next round has to be better. Casino games are still games, so they should be treated as entertainment. The game should never control you &mdash; you decide when to play and when to stop.",
            "Beta kaka mpo na divertissement. Te mpo na revenu, te mpo na \"kozua lisusu\" mbongo, te mpo na ete olingi round elandi ezala malamu. Ba jeux ya casino ezali nokinoki ba jeux, yango wana esengeli kobatelama lokola divertissement. Lisano elingi te kozala na contrôle na yo &mdash; ozali kozua likambo ntango obeta mpe ntango otelema."
        ],
        [
            "You pass one lane and think: okay, maybe one more. Then another. The multiplier is higher now, so cashing out feels a bit too early. At the same time, one bad move can burn the whole bet. This small conflict &mdash; take it now or risk again &mdash; is what keeps the game alive.",
        ...
        [
            "Chicken Road can be entertaining, especially because the rounds are short and the game does not look serious. But it is still gambling. Real money changes the feeling completely. A step that feels funny in demo mode can feel very different when your own balance is involved.",
            "Chicken Road ekoki kozala divertissant, mingi mpo na ba rounds ezali moké mpe lisano ezali te lokola sérieux. Kasi ezali nokinoki gambling. Mbongo ya solo ebongisaka feeling mobimba. Matambe oyo ezali funny na demo ekoki kozala different mingi soki solde na yo ezali na jeu."
        ],
        [
            "Chicken Road works because it doesn't look complicated. That's the first trick. You don't open the game and feel like you need to study rules for ten minutes &mdash; there's a chicken, a road, moving cars, a bet amount, and one clear decision: go forward or take the money.",
            "Chicken Road esalaka mpo na ete ezali te compliqué. Yango ezali trick ya liboso. Osokoli lisano mpe omoni ete osengeli kotanga mibeko mpo na miniti zomi &mdash; ezali nkoko, nzela, mituka oyo ezali kotambola, motango ya pari, mpe likambo moko ya polele: kokende liboso to kozua mbongo."
        ],
        [
            "Yes. Chicken Road can be played for free, with no real money involved &mdash; you get a virtual balance and can test everything without risking your own funds. It's the same game: the same lanes, the same multipliers, the same cars. The only real difference is the balance.",
        ...
        [
            "Every listed casino runs the same InOut Games build of Chicken Road, so the game itself doesn't change &mdash; what differs is the welcome bonus, payment methods, and licensing. Check the bonus terms before you deposit, and start in demo mode if a site is new to you.",
            "Casino moko na moko oyo ezali na liste esalelaka version moko ya Chicken Road ya InOut Games, yango wana lisano moko echange te &mdash; oyo ekeseni ezali bonus ya boyei, ba méthodes ya paiement, mpe licence. Talá ba conditions ya bonus liboso ya deposit, mpe banda na demo soki site ezali sika mpo na yo."
        ],
        [
            "The idea is easy. You place a bet, choose how risky you want the round to be, and start moving the chicken forward. Every safe step increases the multiplier. At any moment you can stop and take the current win, or go one step further and risk losing the whole bet.",
            "Likanisi ezali pétó. Otia pari, oponi riski oyo olingi mpo na round, mpe obanda kosala nkoko ekende liboso. Matambe mosusu oyo ezali malamu ezongisa multiplicateur. Na ntango nyonso okoki kotelema mpe kozua gain ya sikoyo, to kokende matambe moko mosusu mpe kobanga pari mobimba."
        ],
        [
            "When you open the game, the chicken stands near the road. In front of it are several lanes with cars moving across the screen. Before pressing the big green Play button, check your bet size &mdash; once the round starts, the stake is already in the game.",
            "Osokoli lisano, nkoko ezali pene na nzela. Na liboso na ye ezali ba lanes mingi na mituka oyo ezali kotambola na écran. Liboso ya kofina bouton ya vert Play, talá motango ya pari na yo &mdash; round esili kobanda, pari ezali déjà na lisano."
        ],
        [
            "That is the part many players forget. The fact that the game gives you time to think before the next move is intentional. It feels like control. And yes, you do control the moment when you cash out. But you do not control what happens on the next step.",
            "Yango ezali part oyo ba joueurs mingi babosanaka. Likambo ete lisano epesaka yo temps mpo na kokanisa liboso ya matambe elandi ezali intentional. Ezali lokola contrôle. Mpe iyo, ozali na contrôle ya moment ya Cash Out. Kasi ozali na contrôle te ya oyo ekosala na matambe elandi."
        ],
        [
            "Chicken Road launched on 4 April 2024 and quickly became one of InOut Games' breakout titles, thanks to its step-based crash mechanic, four selectable difficulty levels, and a 98% RTP in the original version &mdash; high for a crash-style casino game.",
            "Chicken Road ebimaki na 4 avril 2024 mpe nokinoki ekomi moko ya ba titres ya breakout ya InOut Games, mpo na mécanique yango ya crash oyo etalemi na matambe, ba niveaux minei ya difficulté oyo okoki kopona, mpe RTP ya 98% na version ya ebandeli &mdash; likolo mpo na lisano ya casino ya style crash."
        ],
        [
            "Once the button is pressed, the chicken steps onto the road. If it hasn't been hit by a car, you decide: press Cash Out and take the win at that lane's multiplier, or continue and send the chicken forward again, hoping for a higher payout.",
            "Soki obofini bouton, nkoko etambe na nzela. Soki ekufi te na motuka, ozali kozua likambo: fina Cash Out mpe zua gain na multiplicateur ya lane wana, to kokende mpe kotinda nkoko liboso lisusu, na espoir ya payout ya likolo."
        ],
        [
            "Chicken Road uses a step-based crash mechanic where every successful move increases the multiplier, while the risk changes depending on the selected difficulty level. The player controls when the chicken moves and when to cash out.",
            "Chicken Road esalelaka mécanique ya crash oyo etalemi na matambe, oyo matambe mosusu oyo ezali malamu ezongisa multiplicateur, mpe riski ebongwana na difficulté oponi. Mosali azali na contrôle ntango nkoko ekende mpe ntango Cash Out."
        ],
        [
            "It has a cartoon look, but the mechanic is not childish at all. The game keeps pushing the same question at the player: cash out now, or survive one more step? That \"one more step\" feeling is the main hook. Sometimes too involved.",
            "Ezali na look ya cartoon, kasi mécanique ezali te ya bana. Lisano ebandi kotuna mbala na mbala motuna moko na mosali: Cash Out sikoyo, to boma matambe moko mosusu? Feeling ya \"matambe moko mosusu\" ezali hook ya minene. Parfois ezwaka yo mingi."
        ],
        [
            " family attracts both casual players and people who already know crash games well. New players understand it in seconds; experienced players like the control, the difficulty levels, and the freedom to pick their own risk style.",
            " libota ezali kobenda ba joueurs ya mpoko mpe bato oyo basaleli déjà ba crash games malamu. Ba joueurs ya sika bayebi yango na seconde; ba expérimentés balingaka contrôle, ba niveaux ya difficulté, mpe liberté ya kopona style na bango ya riski."
        ],
        [
            "The game interface is slightly different, as Chicken Road opens in portrait mode. You won't see six lanes, but only one. The difficulty option is collapsed into a single button; tapping it opens the list of available levels.",
            "Interface ya lisano ezali différente moke, mpo Chicken Road esokolaka na mode portrait. Okomonaki te ba lanes motoba, kaka moko. Option ya difficulté ecompressi na bouton moko; soki ofini yango efungolaka liste ya ba niveaux oyo ezali."
        ],
        [
            ", a young provider that has been growing fast in the instant games and crash games market. The studio's signature move is fast-paced, arcade-style casino and crash games &mdash; and Chicken Road fits that style perfectly.",
            ", fournisseur ya moke oyo ezali kokola na mbangu na marché ya ba jeux instantanés mpe ba crash games. Signature ya studio ezali ba jeux ya casino mpe crash ya mbangu na style arcade &mdash; mpe Chicken Road esimbaka style wana malamu."
        ],
        [
            "A stable internet connection is required for a smooth run without delays. But Chicken Road has one advantage here: the game doesn't keep players under constant time pressure, so it remains playable even with some lag.",
            "Connexion ya internet ya stable esengeli mpo na course ya smooth sans retard. Kasi Chicken Road ezali na avantage awa: lisano etelemi te ba joueurs na pression ya temps ya constant, yango wana esimbaka kobeta ata na lag moke."
        ],
        [
            "Chicken Road is a fast casino game from InOut Games. Move the chicken across the road and try to stop before things go wrong. The longer you keep going, the more you can win, but one bad step can burn the whole bet.",
        ...
        [
            "Everything works the same across all devices. Open the website, find the Play Chicken Road button, choose the mode, set your bet, and start the round. Prefer a dedicated app instead of the browser? See our ",
            "Eloko nyonso esalaka ndenge moko na ba appareils nyonso. Fungola site, mona bouton Play Chicken Road, pona mode, botia pari, mpe banda round. Olingi app dédiée na esika ya navigateur? Talá "
        ],
        [
            "What makes the original Chicken Road game different from many other crash games is that it doesn't rush the player. It gives you a moment to think &mdash; the chicken waits, and you decide when to move.",
        ...
        [
            "In Chicken Road, everyone starts looking for a \"system\" sooner or later. Some players stop after one or two safe steps. Some try to reach a bigger multiplier. Some combine different difficulty levels.",
            "Na Chicken Road, moto nyonso ebandi koluka \"système\" mbala moko to sima. Ba joueurs mosusu batelami sima matambe moko to mibale oyo ezali malamu. Basusu bazali komeka multiplicateur ya monene. Basusu bazali kokangisa ba niveaux ya difficulté ekeseni."
        ],
        [
            "That feeling can be dangerous. The player controls the button, not the outcome. You can choose when to stop, but you cannot know if the next lane is safe. This is why Chicken Road became so popular.",
            "Feeling wana ekoki kozala dangerous. Mosali azali na contrôle ya bouton, te ya résultat. Okoki kopona ntango oteleme, kasi okoki koyeba te soki lane elandi ezali malamu. Yango wana Chicken Road ekomi popularité mingi."
        ],
        [
            "This crash title works well on mobile because the game itself is not overloaded. You do not need a big screen to understand what is happening &mdash; the whole mechanic fits a smartphone naturally.",
            "Titre ya crash oyo esalaka malamu na telefone mpo na ete lisano moko ezali te overload. Osengeli écran ya monene mpo na koyeba oyo ezali kosala &mdash; mécanique mobimba esimbaka smartphone na nature."
        ],
        [
            "For this type of game, mobile actually feels like the natural format. Short rounds, simple controls, no heavy interface &mdash; just tap, wait, decide, and cash out when you think it is enough.",
            "Mpo na type ya lisano oyo, telefone ezali vraiment format ya nature. Ba rounds ya moké, contrôles ya simple, interface ya te lourde &mdash; fina kaka, zela, pona, mpe Cash Out soki omoni ete ekoki."
        ],
        [
            "This is the main difference between Chicken Road and classic auto-crash games like Aviator. In Aviator, you mostly watch a multiplier climb on its own and decide when to leave the round. In ",
            "Yango ezali différence ya minene kati na Chicken Road mpe ba jeux ya auto-crash ya classique lokola Aviator. Na Aviator, omoni kaka multiplicateur oyo ekoloka yango moko mpe ozali kozua likambo ntango okoki kobima na round. Na "
        ],
        [
            "Chicken Road also has a strong advantage in its original version: <strong>the RTP is listed at 98%</strong>, high compared to most crash-style casino games. That's noticeably better than ",
            "Chicken Road ezali mpe na avantage ya makasi na version ya ebandeli: <strong>RTP ezali kolisi na 98%</strong>, likolo koleka ba jeux ya casino ya style crash mingi. Yango ezali malamu mingi koleka "
        ],
        [
            "By cashing out before the chicken gets hit &mdash; the longer you wait, the higher the multiplier, but also the higher the risk. There is no trick beyond timing your cash-out; see our ",
            "Na Cash Out liboso ete nkoko ekufi &mdash; soki ozali kozela mingi, multiplicateur ezali likolo, kasi riski ezali mpe likolo. Trick ezali te libela ya timing ya Cash Out; talá "
        ],
        [
            "No. You cannot predict the next step or know in advance when the chicken will lose. The game is based on chance, so any \"predictor\" or guaranteed method should be treated with caution.",
            "Te. Okoki kotya matambe elandi to koyeba liboso ntango nkoko ekobunga. Lisano etalemi na hasard, yango wana \"prédicteur\" nyonso to méthode garantie esengeli kobatelama na prudence."
        ],
        [
            "This is why limits matter. Do not lose more than you can afford. If that amount is gone, stop. Do not try to win it back in the next round. That is usually where bad decisions start.",
            "Yango wana ba limites ezali important. Kobunga te koleka oyo okoki. Soki motango wana esili, telema. Kokanga te kozua yango lisusu na round elandi. Wana ndenge ba mauvaises décisions ebandi."
        ],
        [
            "Chicken Road is easy to understand, but that doesn't mean the game is harmless. The whole round is built around one decision: stop now, or move the chicken one more lane.",
            "Chicken Road ezali pétó koyeba, kasi yango elingi te ete lisano ezali sans danger. Round mobimba etalemi likambo moko: telema sikoyo, to sala nkoko ekende na lane moko mosusu."
        ],
        [
            "Usually not &mdash; the game runs directly in a browser through casino sites. If you'd rather use a dedicated app or add it to your home screen, see our ",
            "Mbala na mbala te &mdash; lisano esalemaka direct na navigateur na ba sites ya casino. Soki olingi app dédiée to kobakisa yango na écran ya liboso, talá "
        ],
        [
            ", you make the chicken move step by step yourself &mdash; it feels more active. You press the button, you see the result, and then you decide again.",
            ", osali nkoko ekende matambe na matambe yo moko &mdash; ezali active mingi. Ofini bouton, omoni résultat, mpe ozali kozua likambo lisusu."
        ],
        [
            "Chicken Road is available at several licensed <strong>Chicken Road casino</strong> brands, each with its own welcome bonus and terms. Compare all ",
            "Chicken Road ezali na ba marques ya <strong>casino ya Chicken Road</strong> oyo ezali na licence mingi, moko na moko na bonus ya boyei mpe ba conditions na yango. Linganisa "
        ],
        [
            ". Some approaches are careful, some are risky, some only make sense in demo mode &mdash; but none of them turns the game into a guaranteed win.",
            ". Ba approches mosusu ezali prudents, mosusu risky, mosusu ezali kaka na sens na demo &mdash; kasi moko te ebongisaka lisano na gain garanti."
        ],
        [
            ", the sequel released in 2025, which runs at 95.5% RTP in exchange for faster pacing and bigger visual swings. See the comparison table below.",
            ", suite oyo ebimaki na 2025, oyo esalelaka RTP ya 95.5% mpo na rythme ya mbangu mpe ba changements ya visual ya monene. Talá tableau ya comparison na nse."
        ],
        [
            "Yes, wherever a licensed operator offers it &mdash; always check that the casino holds a valid UK licence before you deposit.",
        ...
        [
            "There are different approaches, but no strategy guarantees profit. A strategy can help control your play, not beat the game.",
            "Ezali na ba approches ekeseni, kasi stratégie moko te epesi gain garanti. Stratégie ekoki kosalisa contrôle ya jeu na yo, te kobunda lisano."
        ],
        [
            "The flow is short: set your bet and difficulty, move the chicken step by step, and cash out before a trap ends the run.",
        ...
        [
            "Move the chicken when you are ready. Each safe step increases the multiplier on screen.",
            "Sala nkoko ekende soki ozali prêt. Matambe mosusu oyo ezali malamu ezongisa multiplicateur na écran."
        ],
        [
            "<strong>Quick-start checklist before your first Chicken Road round:</strong>",
        ...
        [
            " is the better pick. Want the newer, faster version instead? Read the full ",
            " ezali choix ya malamu. Olingi version ya sika mpe ya mbangu? Tanga "
        ],
        [
            "Decide your cash-out target before you press Play, not during the round.",
        ...
        [
            ". This provider is known for fast, arcade-style casino games.",
            ". Fournisseur oyo eyebani mpo na ba jeux ya casino ya mbangu na style arcade."
        ],
        [
            "Why the Chicken Road Casino Game Pulls Players In So Quickly",
            "Mpo na Nini Lisano ya Casino Chicken Road Ezali Kobenda Ba Joueurs Nokinoki"
        ],
        [
            "Chicken Road multiplier climbing during a live casino round",
        ...
        [
            "Chicken Road Strategies, Risks, and Responsible Play",
            "Ba Stratégies ya Chicken Road, Ba Risques, mpe Kobeta na Responsabilité"
        ],
        [
            "Players who like quick rounds and simple mechanics",
            "Ba joueurs oyo balingaka ba rounds ya mbangu mpe mécanique ya simple"
        ],
        [
            "it feels like you can stop at the perfect moment;",
        ...
        [
            " players actually use, plus a dedicated guide on ",
            " oyo ba joueurs basalelaka vraiment, mpe guide dédié na "
        ],
        [
            "Chicken Road Demo &mdash; Can You Play for Free?",
        ...
        [
            "Busier \"traffic\" theme, same core mechanic",
            "Thème ya \"trafic\" oyo ezali busy, mécanique ya core moko"
        ],
        [
            "Is Chicken Road available on smartphones?",
        ...
        [
            "Is there a working Chicken Road strategy?",
            "Stratégie ya Chicken Road oyo esalaka ezali?"
        ],
        [
            "short rounds make it easy to play again;",
            "ba rounds ya moké esalelaka ete ezala pétó kobeta lisusu;"
        ],
        [
            "Chicken Road Game Casino: Where to Play",
        ...
        [
            "\"Just one more step\" feeling",
            "Feeling ya \"matambe moko mosusu\""
        ],
        [
            "Can I download Chicken Road?",
            "Nakoki ko télécharger Chicken Road?"
        ],
        [
            "Chicken Road in Three Steps",
