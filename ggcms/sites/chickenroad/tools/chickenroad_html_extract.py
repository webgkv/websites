...
def extract_english(html: str | None = None) -> dict:
    ...
    faq_block = html.split("Chicken Road FAQ", 1)[-1]
    ...
    return {
        "what_paras": _paras_after(r"1\. What Is Chicken Road\?</span></h2>", html),
        "works_paras": _paras_after(r"2\. How Chicken Road Works</span></h2>", html),
        "why_paras": _paras_after(r"3\. Why Chicken Road Pulls Players In So Quickly\s*</span></h2>", html),
        "demo_paras": _paras_after(r"4\. Chicken Road Demo.*?Free\?\s*</span></h2>", html),
        "mobile_paras": _paras_after(r"5\. Chicken Road on Mobile</span></h2>", html),
