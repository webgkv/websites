...
<div class="main__frame main__frame--app-shell">
	<div class="main__frame-app-inner">
		<iframe class="spribe-demo-iframe chickenroad-demo-iframe" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" title="Chicken Road 2 Demo" src="<?= htmlspecialchars($demo_iframe_url, ENT_QUOTES, 'UTF-8') ?>" width="300" height="150" frameborder="0" scrolling="no" allow="autoplay; fullscreen" allowfullscreen>Browser not compatible.</iframe>
	</div>
</div>
