...
// Brand (Chicken Road)
$config['site_brand_name'] = 'Chicken Road';
$config['site_title_suffix'] = ' | Chicken Road';
$config['site_apk_filename'] = 'chickenroad.apk';
...
$config['mysql_username']	= 'dikodo_chickenroad';
$config['mysql_password']	= '3v?J?u&@w/)0e!Vf';
$config['mysql_database']	= 'dikodo_chickenroad';
...
// Demo page: iframe URL for Chicken Road (InOut Games). Leave empty to hide the block. Uses iDev.Games free embed.
