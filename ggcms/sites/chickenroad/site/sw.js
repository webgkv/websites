...
/* Chicken Road — minimal PWA service worker (offline shell + asset cache). */
const STATIC_CACHE = 'chickenroad-static-v3';
				...
				return Promise.all(
					keys
						.filter(function (key) {
							...
							return key.indexOf('chickenroad-static-') === 0 && key !== STATIC_CACHE;
						})
						.map(function (key) {
