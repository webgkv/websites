...
$config['https']='1';
$config['domain_main']='powerballjackpot.run';
// $config['domain_main_redirect']='1';
$config['dummy']='0';
$config['uploader']='1';
$config['brevo']='';

// Brand (PowerBall Jackpot)
$config['site_brand_name'] = 'PowerBall Jackpot';
$config['site_title_suffix'] = ' | PowerBall Jackpot';
$config['site_apk_filename'] = 'powerballjackpot.apk';
$config['site_hero_image'] = '/assets/images/chickenroad-hero.webp';
...
// InOut demo defaults (Chicken Road 2 — same as chickenrd2.com iframe):
// $config['chickenroad_inout_demo_host'] = 'https://chicken-road-two.inout.games';
// $config['chickenroad_inout_game_mode'] = 'chicken-road-two';
// $config['chickenroad_inout_operator_id'] = 'ee2013ed-e1f0-4d6e-97d2-f36619e2eb52';
// $config['chickenroad_inout_auth_token'] = '247d3637-c5dc-a67b-50a1-89df27733343';
// $config['chickenroad_inout_demo_currency'] = 'USD'; // required for demo; geo RON/EUR can hang the client
// $config['chickenroad_inout_use_launch_api'] = true; // api.inout.games/api/launch → game host (default)
...
$config['blog_google_deindex'] = true;
...
$config['mysql_username']	= 'dikodo_powerball';
$config['mysql_password']	= 'niat!lLOGgkAJ6?9';
$config['mysql_database']	= 'dikodo_powerball';

//if(isset($_ENV['CI_COMMIT_REF_SLUG'])&&$_ENV['CI_COMMIT_REF_SLUG']=='main') {
//	$config['mysql_username']	= '1x2md_dev_user';
//	$config['mysql_password']	= 'tF8#nR3$bK6xL9@m';
