 ...
 * CLI: php scripts/apply_powerballjackpot_brand_prod.php
 */
...
$_SERVER['HTTP_HOST'] = $_SERVER['HTTP_HOST'] ?? 'powerballjackpot.run';
...
$preset_path = ROOT_DIR . 'files/reference/seo_structured-powerballjackpot-preset.json';
