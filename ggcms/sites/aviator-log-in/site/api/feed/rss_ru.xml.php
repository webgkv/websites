...
$content.='<channel><title><![CDATA[Aviator Log-in Blog]]></title><description><![CDATA[Aviator Log-in Blog]]></description><link>'.$rss_domain.'/'.$lang['url'].'/'.$modules['blog'].'/</link><image><url>'.$rss_domain.'/assets/logo.png</url><title>Aviator Log-in Blog</title><link>'.$rss_domain.'/'.$lang['url'].'/'.$modules['blog'].'/</link></image>';
