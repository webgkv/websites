...
$content_section_urls = array('blog', 'guides', 'games', 'casinos', 'demo', 'predictor', 'download', 'install-pwa', 'ios-pwa', 'install-apk');
...
if (isset($get['u']) && $get['u'] === 'form' && isset($get['id']) && $get['id'] !== 'new' && ($_page_id = intval($get['id'])) > 0) {
	...
	$_content_section_urls = array('blog', 'guides', 'games', 'casinos');
