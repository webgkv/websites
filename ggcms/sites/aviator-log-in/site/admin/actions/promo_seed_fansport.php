<?php
/**
 * Seed: FanSport free spins promo landing (aviator-log-in).
...
if (!function_exists('promo_seed_fansport_html')) {
	function promo_seed_fansport_html($lang_prefix = '/en/') {
		...
		$go = 'https://tcdu1.live/t.php?o=gc6R0';
...
<section class="promo-land promo-land--fansport">
	<div class="promo-land-hero">
		<div class="promo-land-hero__visual" aria-hidden="true">
			<img src="/files/media/2026/07/aviator-fansport-fs.webp" alt="" width="640" height="360" loading="eager" class="promo-land-hero__img">
			<div class="promo-land-hero__glow"></div>
		</div>
		<p class="promo-land-hero__eyebrow">FanSport × Aviator · Free Spins</p>
	...
	<div class="promo-land-body about_content">
		...
		<p class="promo-land-foot-cta">
			...
			<a href="{$demo}" class="promo-land-btn-ghost">Aviator demo</a>
		</p>
	</div>
</section>
HTML;
...
if (@mysql_select("SHOW TABLES LIKE 'promo'", 'num_rows') > 0) {
	...
	$promo_img = 'files/media/2026/07/aviator-fansport-fs.webp';
	...
	$seed_row = array(
		'name' => 'Free Spins — FanSport × Aviator',
		'name_2' => 'Your free spins are ready — log in or register to claim at FanSport.',
		'url' => $seed_slug,
		'text' => promo_seed_fansport_html(),
		'title' => 'Your Free Spins Are Ready | FanSport × Aviator',
		'description' => 'A new free spins gift is waiting in your FanSport account. Log in or register to claim it and enjoy extra Aviator rounds.',
		'img' => $promo_img,
		'updated_at' => $now,
	);
	if (!$exists) {
