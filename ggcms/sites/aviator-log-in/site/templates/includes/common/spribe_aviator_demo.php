...
// Resolved PHP parameters to bootstrap our client-side loader
...
<div class="main__frame main__frame--app-shell" style="background: #151b24; overflow: hidden;">
	<div class="main__frame-app-inner" style="position: relative; width: 100%; height: 100%;">
		...
		<!-- Game Iframe -->
		<iframe id="iframe_<?= $uniqueId ?>" class="spribe-demo-iframe" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: none; opacity: 0; transition: opacity 0.8s ease;" title="Aviator Demo" allowfullscreen>Browser not compatible.</iframe>
	</div>
</div>
