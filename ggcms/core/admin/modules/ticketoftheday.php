...
for($i=1;$i<=20;$i++) {
//  $form[2][] = '</div><div class="form-row" style="background:#'.($i%2?'EEE':'FFF').';padding:10px 0;margin:10px 0">';
...
document.addEventListener("DOMContentLoaded", function () {
	...
	$(document).on("change",".sport",function() {
		...
		$.get(
			"/admin.php?m=ticketoftheday&u=get_teams",
